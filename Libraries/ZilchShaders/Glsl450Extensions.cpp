...
ZilchShaderIROp* MakeBasicExtensionFunction(ZilchSpirVFrontEnd* translator, Zilch::FunctionCallNode* functionCallNode, int extensionOpId, ZilchShaderExtensionImport* importLibraryIR, ZilchSpirVFrontEndContext* context)
{
...
void BasicExtensionFunction(ZilchSpirVFrontEnd* translator, Zilch::FunctionCallNode* functionCallNode, Zilch::MemberAccessNode* memberAccessNode, ZilchShaderExtensionImport* importLibraryIR, ZilchSpirVFrontEndContext* context)
{
  ZilchShaderIROp* extensionOp = MakeBasicExtensionFunction(translator, functionCallNode, extensionOpId, importLibraryIR, context);
...
void ResolveGlslExtensionFunction(ZilchSpirVFrontEnd* translator, Zilch::FunctionCallNode* functionCallNode, Zilch::MemberAccessNode* memberAccessNode, ZilchSpirVFrontEndContext* context)
{
  ...
  ZilchShaderIROp* extensionOp = MakeBasicExtensionFunction(translator, functionCallNode, userData.mOpCode, importOp, context);
...
void GenerateFSign(ZilchSpirVFrontEnd* translator, Zilch::FunctionCallNode* functionCallNode, Zilch::MemberAccessNode* memberAccessNode, ZilchShaderExtensionImport* importLibraryIR, ZilchSpirVFrontEndContext* context)
{
  BasicBlock* currentBlock = context->GetCurrentBlock();

  ZilchShaderIRType* intResultType = translator->FindType(functionCallNode->ResultType, functionCallNode);
  ZilchShaderIRType* realResultType = translator->FindType(functionCallNode->Arguments[0]->ResultType, functionCallNode);
  ...
  ZilchShaderIROp* intSignOp = translator->BuildIROp(currentBlock, OpType::OpConvertFToS, intResultType, extensionOp, context);
...
void GenerateAngleAndTrigFunctions(SpirVExtensionLibrary* extLibrary, TypeGroups& types)
{
  ...
  for(size_t i = 0; i < types.mRealVectorTypes.Size(); ++i)
  {
    ...
    extLibrary->CreateExtInst(GetStaticFunction(mathType, "ToRadians", zilchTypeName), BasicExtensionFunction<GLSLstd450Radians>);
    extLibrary->CreateExtInst(GetStaticFunction(mathType, "ToDegrees", zilchTypeName), BasicExtensionFunction<GLSLstd450Degrees>);
    ...
    extLibrary->CreateExtInst(GetStaticFunction(mathType, "ACos", zilchTypeName), BasicExtensionFunction<GLSLstd450Acos>);
    extLibrary->CreateExtInst(GetStaticFunction(mathType, "ASin", zilchTypeName), BasicExtensionFunction<GLSLstd450Asin>);
    extLibrary->CreateExtInst(GetStaticFunction(mathType, "ATan", zilchTypeName), BasicExtensionFunction<GLSLstd450Atan>);
    extLibrary->CreateExtInst(GetStaticFunction(mathType, "ATan2", zilchTypeName, zilchTypeName), BasicExtensionFunction<GLSLstd450Atan2>);

    extLibrary->CreateExtInst(GetStaticFunction(mathType, "Cosh", zilchTypeName), BasicExtensionFunction<GLSLstd450Cosh>);
    extLibrary->CreateExtInst(GetStaticFunction(mathType, "Sinh", zilchTypeName), BasicExtensionFunction<GLSLstd450Sinh>);
    extLibrary->CreateExtInst(GetStaticFunction(mathType, "Tanh", zilchTypeName), BasicExtensionFunction<GLSLstd450Tanh>);
  }
}
...
void GenerateExponentialFunctions(SpirVExtensionLibrary* extLibrary, TypeGroups& types)
{
  ...
  for(size_t i = 0; i < types.mRealVectorTypes.Size(); ++i)
  {
    ...
    extLibrary->CreateExtInst(GetStaticFunction(mathType, "Pow", zilchTypeName, zilchTypeName), BasicExtensionFunction<GLSLstd450Pow>);
    ...
    extLibrary->CreateExtInst(GetStaticFunction(mathType, "Log2", zilchTypeName), BasicExtensionFunction<GLSLstd450Log2>);
    extLibrary->CreateExtInst(GetStaticFunction(mathType, "Exp2", zilchTypeName), BasicExtensionFunction<GLSLstd450Exp2>);
    extLibrary->CreateExtInst(GetStaticFunction(mathType, "Sqrt", zilchTypeName), BasicExtensionFunction<GLSLstd450Sqrt>);
    extLibrary->CreateExtInst(GetStaticFunction(mathType, "RSqrt", zilchTypeName), BasicExtensionFunction<GLSLstd450InverseSqrt>);
  }
}
...
void GenerateCommonFloatFunctions(SpirVExtensionLibrary* extLibrary, TypeGroups& types)
{
  ...
  for(size_t i = 0; i < types.mRealVectorTypes.Size(); ++i)
  {
    ...
    extLibrary->CreateExtInst(GetStaticFunction(mathType, "Abs", zilchTypeName), BasicExtensionFunction<GLSLstd450FAbs>);
    extLibrary->CreateExtInst(GetStaticFunction(mathType, "Sign", zilchTypeName), GenerateFSign);
    extLibrary->CreateExtInst(GetStaticFunction(mathType, "Floor", zilchTypeName), BasicExtensionFunction<GLSLstd450Floor>);
    extLibrary->CreateExtInst(GetStaticFunction(mathType, "Ceil", zilchTypeName), BasicExtensionFunction<GLSLstd450Ceil>);
    extLibrary->CreateExtInst(GetStaticFunction(mathType, "Frac", zilchTypeName), BasicExtensionFunction<GLSLstd450Fract>);
    extLibrary->CreateExtInst(GetStaticFunction(mathType, "Truncate", zilchTypeName), BasicExtensionFunction<GLSLstd450Trunc>);
    extLibrary->CreateExtInst(GetStaticFunction(mathType, "Round", zilchTypeName), BasicExtensionFunction<GLSLstd450Round>);

    extLibrary->CreateExtInst(GetStaticFunction(mathType, "Min", zilchTypeName, zilchTypeName), BasicExtensionFunction<GLSLstd450FMin>);
    extLibrary->CreateExtInst(GetStaticFunction(mathType, "Max", zilchTypeName, zilchTypeName), BasicExtensionFunction<GLSLstd450FMax>);
    extLibrary->CreateExtInst(GetStaticFunction(mathType, "Clamp", zilchTypeName, zilchTypeName, zilchTypeName), BasicExtensionFunction<GLSLstd450FClamp>);
    extLibrary->CreateExtInst(GetStaticFunction(mathType, "Lerp", zilchTypeName, zilchTypeName, zilchTypeName), BasicExtensionFunction<GLSLstd450FMix>);
    extLibrary->CreateExtInst(GetStaticFunction(mathType, "Step", zilchTypeName, zilchTypeName), BasicExtensionFunction<GLSLstd450Step>);
    extLibrary->CreateExtInst(GetStaticFunction(mathType, "SmoothStep", zilchTypeName, zilchTypeName, zilchTypeName), BasicExtensionFunction<GLSLstd450SmoothStep>);
  }
}
...
void GenerateCommonIntFunctions(SpirVExtensionLibrary* extLibrary, TypeGroups& types)
{
  ...
  for(size_t i = 0; i < types.mIntegerVectorTypes.Size(); ++i)
  {
    ...
    extLibrary->CreateExtInst(GetStaticFunction(mathType, "Abs", zilchTypeName), BasicExtensionFunction<GLSLstd450SAbs>);
    extLibrary->CreateExtInst(GetStaticFunction(mathType, "Clamp", zilchTypeName, zilchTypeName, zilchTypeName), BasicExtensionFunction<GLSLstd450SClamp>);
    extLibrary->CreateExtInst(GetStaticFunction(mathType, "Min", zilchTypeName, zilchTypeName), BasicExtensionFunction<GLSLstd450SMin>);
    extLibrary->CreateExtInst(GetStaticFunction(mathType, "Max", zilchTypeName, zilchTypeName), BasicExtensionFunction<GLSLstd450SMax>);

    extLibrary->CreateExtInst(GetStaticFunction(mathType, "Sign", zilchTypeName), BasicExtensionFunction<GLSLstd450SSign>);
  }
}
...
void GenerateGeometricFloatFunctions(SpirVExtensionLibrary* extLibrary, TypeGroups& types)
{
  ...
  for(size_t i = 1; i < types.mRealVectorTypes.Size(); ++i)
  {
    ...
    extLibrary->CreateExtInst(GetStaticFunction(mathType, "Distance", zilchTypeName, zilchTypeName), BasicExtensionFunction<GLSLstd450Distance>);
    extLibrary->CreateExtInst(GetStaticFunction(mathType, "Length", zilchTypeName), BasicExtensionFunction<GLSLstd450Length>);
    extLibrary->CreateExtInst(GetStaticFunction(mathType, "Normalize", zilchTypeName), BasicExtensionFunction<GLSLstd450Normalize>);
...
void CreateFloatMatrixFunctions(SpirVExtensionLibrary* extLibrary, TypeGroups& types)
{
  ...
  for(size_t i = 2; i <= 4; ++i)
  {
    ...
    extLibrary->CreateExtInst(GetStaticFunction(mathType, "Invert", zilchTypeName), BasicExtensionFunction<GLSLstd450MatrixInverse>);
    extLibrary->CreateExtInst(GetStaticFunction(mathType, "Determinant", zilchTypeName), BasicExtensionFunction<GLSLstd450Determinant>);
  }
}
...
void AddGlslExtensionIntrinsicOps(Zilch::LibraryBuilder& builder, SpirVExtensionLibrary* extLibrary, Zilch::BoundType* type, TypeGroups& types)
{
  ...
  for(size_t i = 0; i < types.mRealVectorTypes.Size(); ++i)
  {
    ...
    AddGlslIntrinsic(builder, type, extLibrary, GLSLstd450Atan2, "ATan2", TwoParameters(zilchType, "y", zilchType, "x"), zilchType);
    AddGlslIntrinsic(builder, type, extLibrary, GLSLstd450Pow, "Pow", TwoParameters(zilchType, "base", zilchType, "exp"), zilchType);
    ...
    AddGlslIntrinsic(builder, type, extLibrary, GLSLstd450InverseSqrt, "InverseSqrt", OneParameter(zilchType), zilchType);
    ...
    AddGlslIntrinsic(builder, type, extLibrary, GLSLstd450FClamp, "FClamp", ThreeParameters(zilchType, "value", zilchType, "minValue", zilchType, "maxValue"), zilchType);
    AddGlslIntrinsic(builder, type, extLibrary, GLSLstd450FMix, "FMix", ThreeParameters(zilchType, "start", zilchType, "end", zilchType, "t"), zilchType);
    AddGlslIntrinsic(builder, type, extLibrary, GLSLstd450Step, "Step", TwoParameters(zilchType, "y", zilchType, "x"), zilchType);
    AddGlslIntrinsic(builder, type, extLibrary, GLSLstd450SmoothStep, "SmoothStep", ThreeParameters(zilchType, "start", zilchType, "end", zilchType, "t"), zilchType);
    AddGlslIntrinsic(builder, type, extLibrary, GLSLstd450Fma, "Fma", ThreeParameters(zilchType, "a", zilchType, "b", zilchType, "c"), zilchType);

    AddGlslIntrinsic(builder, type, extLibrary, GLSLstd450Length, "Length", OneParameter(zilchType), realType);
    AddGlslIntrinsic(builder, type, extLibrary, GLSLstd450Distance, "Distance", TwoParameters(zilchType, zilchType), realType);
    AddGlslIntrinsic(builder, type, extLibrary, GLSLstd450Normalize, "Normalize", OneParameter(zilchType), zilchType);
    AddGlslIntrinsic(builder, type, extLibrary, GLSLstd450FaceForward, "FaceForward", ThreeParameters(zilchType, "n", zilchType, "i", zilchType, "nRef"), zilchType);
    AddGlslIntrinsic(builder, type, extLibrary, GLSLstd450Reflect, "Reflect", TwoParameters(zilchType, "i", zilchType, "n"), zilchType);
    AddGlslIntrinsic(builder, type, extLibrary, GLSLstd450Refract, "Refract", ThreeParameters(zilchType, "i", zilchType, "n", realType, "eta"), zilchType);

    // Causes SpirV-Cross exceptions
    //AddGlslIntrinsic(builder, type, extLibrary, GLSLstd450NMin, "NMin", TwoParameters(zilchType, zilchType), zilchType);
    //AddGlslIntrinsic(builder, type, extLibrary, GLSLstd450NMax, "NMax", TwoParameters(zilchType, zilchType), zilchType);
    //AddGlslIntrinsic(builder, type, extLibrary, GLSLstd450NClamp, "NClamp", ThreeParameters(zilchType, "value", zilchType, "minValue", zilchType, "maxValue"), zilchType);

    // Requires pointer types
    //AddGlslIntrinsic(builder, type, extLibrary, GLSLstd450Modf, "Modf", TwoParameters(zilchType, "value"), zilchType);
  }
  ...
  for(size_t i = 0; i < types.mIntegerVectorTypes.Size(); ++i)
  {
    ...
    AddGlslIntrinsic(builder, type, extLibrary, GLSLstd450SClamp, "SClamp", ThreeParameters(zilchType, "value", zilchType, "minValue", zilchType, "maxValue"), zilchType);
    AddGlslIntrinsic(builder, type, extLibrary, GLSLstd450FindILsb, "FindLeastSignificantBit", OneParameter(zilchType, "value"), zilchType);
    AddGlslIntrinsic(builder, type, extLibrary, GLSLstd450FindSMsb, "FindMostSignificantBit", OneParameter(zilchType, "value"), zilchType);
  }
  ...
  for(size_t i = 2; i <= 4; ++i)
  {
    ...
    AddGlslIntrinsic(builder, type, extLibrary, GLSLstd450MatrixInverse, "MatrixInverse", OneParameter(zilchType), zilchType);
  }
