...
void OperatorResolvers::RegisterBinaryOpResolver(Zilch::Type* lhsType,
                                                 Zilch::Type* rhsType,
...
void OperatorResolvers::RegisterUnaryOpResolver(Zilch::Type* type,
                                                Zilch::Grammar::Enum op,
...
void StageRequirementsData::Combine(Zilch::Member* dependency,
