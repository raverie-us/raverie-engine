...
ZilchShaderIROp* ShaderInterfaceStruct::GetFieldPointerByIndex(size_t index,
...
ZilchShaderIROp* ShaderInterfaceStruct::GetFieldPointerByIndex(ZilchShaderIROp* instance,
                                                               size_t index,
                                                               EntryPointGeneration* entryPointGeneration,
                                                               BasicBlock* block,
                                                               spv::StorageClass storageClass)
                                                ...
                                                EntryPointInfo* entryPointInfo)
{
  ...
  ZilchShaderIROp* interfaceInstance = translator->BuildOpVariable(
                                              ...
                                              EntryPointHelperFunctionData& copyHelperData)
{
  ...
  for (size_t i = 0; i < mFields.Size(); ++i)
  {
    ...
    for (size_t j = 0; j < fieldInfo.mLinkedFields.Size(); ++j)
    {
      ...
      ZilchShaderIROp* blockAccessChainOp = translator->BuildIROp(
...
ZilchShaderIROp* ShaderInterfaceGlobals::GetFieldPointerByIndex(size_t index,
                                                                EntryPointGeneration* entryPointGeneration,
                                                                BasicBlock* block,
                                                                spv::StorageClass storageClass)
{
                                                 ...
                                                 EntryPointInfo* entryPointInfo)
{
  ...
  for (size_t i = 0; i < fieldList.Size(); ++i)
  {
    ...
    ZilchShaderIROp* varOp = translator->BuildOpVariable(
...
ZilchShaderIROp* ShaderInterfaceStructArray::GetPointerByIndex(IZilchShaderIR* index,
...
void EntryPointGeneration::DeclareVertexInterface(ZilchSpirVFrontEnd* translator,
                                                  Zilch::GenericFunctionNode* node,
...
void EntryPointGeneration::DeclareGeometryInterface(ZilchSpirVFrontEnd* translator,
                                                    Zilch::GenericFunctionNode* node,
                                                    ZilchShaderIRFunction* function,
                                                    ZilchSpirVFrontEndContext* context)
{
...
void EntryPointGeneration::DeclarePixelInterface(ZilchSpirVFrontEnd* translator,
                                                 Zilch::GenericFunctionNode* node,
                                                 ZilchShaderIRFunction* function,
                                                 ZilchSpirVFrontEndContext* context)
{
...
void EntryPointGeneration::DeclareComputeInterface(ZilchSpirVFrontEnd* translator,
                                                   Zilch::GenericFunctionNode* node,
                                                   ZilchShaderIRFunction* function,
                                                   ZilchSpirVFrontEndContext* context)
{
...
void EntryPointGeneration::CreateEntryPointFunction(Zilch::GenericFunctionNode* node,
                                                    ZilchShaderIRFunction* function,
                                                    ...
                                                    BasicBlock*& entryPointBlock)
{
  ...
  ZilchShaderIROp* constructorOp = translator->BuildIROp(
      entryPointBlock, OpType::OpFunctionCall, defaultConstructorReturnType, defaultConstructorFn, selfVarOp, context);
}

void EntryPointGeneration::BuildBasicEntryPoint(Zilch::GenericFunctionNode* node,
                                                ZilchShaderIRFunction* function,
...
EntryPointHelperFunctionData EntryPointGeneration::GenerateCopyHelper(ZilchShaderIRFunction* userMainFn,
                                                                      StringParam name)
{
  ZilchSpirVFrontEnd* translator = mTranslator;
  ZilchSpirVFrontEndContext* context = mContext;
  ...
  ZilchShaderIROp* selfParam = translator->BuildIROp(
...
EntryPointHelperFunctionData EntryPointGeneration::GenerateGeometryCopyHelper(ZilchShaderIRFunction* userMainFn,
                                                                              StringParam name,
...
void EntryPointGeneration::WriteGeometryStageInterface(ZilchShaderIRFunction* function,
                                                 ...
                                                 Array<ShaderInterfaceType*>& inputVertexInterfaceTypes)
{
  ...
  ZilchShaderIRType* arrayType = translator->MakeTypeAndPointer(translator->mLibrary,
                                                         ...
                                                         ZilchShaderIRType* outputStreamType)
{
  ...
  Zilch::Function* zilchAppendFn =
      GetMemberOverloadedFunction(zilchStreamType, "Append", outputVertexType->mName, "Integer");
...
ZilchShaderIRFunction* EntryPointGeneration::CloneAppendFn(ZilchShaderIRFunction* originalAppendFn)
{
  ...
  for (size_t i = 0; i < originalParameterBlock->mLines.Size(); ++i)
  {
    ...
    ZilchShaderIROp* newParameterOp = translator->BuildIROp(
...
void EntryPointGeneration::CollectInterfaceVariables(ZilchShaderIRFunction* function,
                                                     ShaderInterfaceInfo& interfaceInfo,
...
void EntryPointGeneration::CollectInputInterfaceVariables(ZilchShaderIRFunction* function,
                                                          ShaderInterfaceInfo& interfaceInfo,
...
void EntryPointGeneration::CollectOutputInterfaceVariables(ZilchShaderIRFunction* function,
                                                           ShaderInterfaceInfo& interfaceInfo,
                                                           ZilchShaderIRType* type,
                                                           ShaderStage::Enum shaderStage)
{
...
void EntryPointGeneration::CollectUniformInterfaceVariables(ZilchShaderIRFunction* function,
                                                            ShaderInterfaceInfo& interfaceInfo,
                                                            ZilchShaderIRType* type,
                                                            ShaderStage::Enum shaderStage)
{
...
InterfaceInfoGroup* EntryPointGeneration::ProcessBuiltIn(ZilchShaderIRFunction* function,
                                                         ShaderInterfaceInfo& interfaceInfo,
                                                         ShaderStage::Enum shaderStage,
...
InterfaceInfoGroup*
EntryPointGeneration::ProcessUniformBlock(ZilchShaderIRFunction* function,
                                          ShaderInterfaceInfo& interfaceInfo,
                                          ShaderIRFieldMeta* fieldMeta,
                                          ShaderIRAttribute* attribute,
                                          HashMap<ShaderFieldKey, UniformBufferDescription*>& mapping)
                                     ...
                                     ZilchShaderIROp* dest)
{
  ...
  if (sourceValueType->mBaseType == ShaderIRTypeBaseType::FixedArray)
  {
    ...
    for (size_t i = 0; i < sourceValueType->mComponents; ++i)
    {
      ...
      ZilchShaderIROp* sourceElement = translator->BuildIROp(
      ...
      ZilchShaderIROp* destElement = translator->BuildIROp(
                                                 ...
                                                 spv::StorageClass sourceStorageClass)
{
  ...
  if (sourceBaseType == ShaderIRTypeBaseType::FixedArray)
  {
    ...
    for (int index = 0; index < sourceSize; ++index)
    {
      ...
      ZilchShaderIROp* sourceItem = translator->BuildIROp(
          block, OpType::OpAccessChain, sourceArrayItemType->mPointerType, source, indexConstant, context);
      ZilchShaderIROp* destItem = translator->BuildIROp(
...
ZilchShaderIROp* EntryPointGeneration::GetMemberInstanceFrom(BasicBlock* block,
                                                             ZilchShaderIROp* source,
                                                             int sourceOffset,
                                                             spv::StorageClass sourceStorageClass)
{
...
ZilchShaderIROp* EntryPointGeneration::GetNamedMemberInstanceFrom(BasicBlock* block,
                                                                  ZilchShaderIROp* source,
...
void EntryPointGeneration::AddMemberTypeDecorations(ZilchShaderIRType* memberType,
                                                    InterfaceInfoGroup::FieldInfo& fieldInfo,
                                                  ...
                                                  ZilchShaderIRConstantLiteral* memberIndexLiteral)
{
  ...
  for (size_t i = 0; i < decorations.Size(); ++i)
  {
    ...
    ZilchShaderIRConstantLiteral* builtInDecoration =
        translator->GetOrCreateConstantIntegerLiteral(decoration.mDecorationType);
    ZilchShaderIROp* decorationOp = translator->BuildIROp(
                                                      ...
                                                      ShaderStageResource& stageResource)
{
  ...
  case ShaderIRTypeBaseType::Matrix:
  {
    ...
    translator->BuildMemberDecorationOp(
        decorationBlock, zilchRuntimeArrayType, 0, spv::DecorationMatrixStride, matrixStride, context);
...
ZilchShaderIROp* EntryPointGeneration::FindField(ShaderFieldKey& fieldKey,
...
void EntryPointGeneration::PerspectiveTransformAppendVertexCallback(AppendCallbackData& callbackData, void* userData)
{
  ...
  if (apiPerspectivePosition != nullptr && transformMatrixOp != nullptr && index != nullptr)
  {
    ...
    ZilchShaderIROp* result = self->mTranslator->BuildIROp(
