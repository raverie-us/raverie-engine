...
class SimpleZilchParserContext
    : public Zilch::WalkerContext<SimpleZilchParser, SimpleZilchParserContext>
{
public:
...
public:
  ...
  void WalkLocalRef(Zilch::LocalVariableReferenceNode*& node,
                    SimpleZilchParserContext* context);
  void WalkGetterSetter(Zilch::MemberAccessNode*& node,
  ...
  typedef Zilch::BranchWalker<SimpleZilchParser, SimpleZilchParserContext>
      ParserBranchWalker;
