...
public:
  ...
  ZilchShaderIRType* FindOrCreatePointerInterfaceType(ZilchShaderIRLibrary* shaderLibrary, ZilchShaderIRType* valueType, spv::StorageClass storageClass);
  ShaderIRTypeMeta* MakeShaderTypeMeta(ZilchShaderIRType* shaderType, Zilch::NodeList<Zilch::AttributeNode>* nodeAttributeList);
  ...
  void ParseAttributes(Zilch::Array<Zilch::Attribute>& zilchAttributes, Zilch::NodeList<Zilch::AttributeNode>* attributeNodes, ShaderIRTypeMeta* typeMeta);
  // Parse and validate attributes for a function. If no locations are available then the nodes will be null (e.g. native types).
  void ParseAttributes(Zilch::Array<Zilch::Attribute>& zilchAttributes, Zilch::NodeList<Zilch::AttributeNode>* attributeNodes, ShaderIRFunctionMeta* functionMeta);
  // Parse and validate attributes for a field. If no locations are available then the nodes will be null (e.g. native types).
  void ParseAttributes(Zilch::Array<Zilch::Attribute>& zilchAttributes, Zilch::NodeList<Zilch::AttributeNode>* attributeNodes, ShaderIRFieldMeta* fieldMeta);
  void ParseZilchAttributes(Zilch::Array<Zilch::Attribute>& zilchAttributes, Zilch::NodeList<Zilch::AttributeNode>* attributeNodes, ShaderIRAttributeList& shaderAttributes);
  // Loads a zilch attribute into an IR attribute. Uses the node's location if available.
  void ParseZilchAttribute(Zilch::Attribute& zilchAttribute, Zilch::AttributeNode* attributeNode, ShaderIRAttributeList& shaderAttributes);
  ...
  void GenerateFunctionType(Zilch::SyntaxNode* locationNode, ZilchShaderIRFunction* function, Zilch::Function* zilchFunction, ZilchSpirVFrontEndContext* context);
  ...
  void DefaultConstructType(Zilch::SyntaxNode* locationNode, ZilchShaderIRType* type, ZilchShaderIROp* selfVar, ZilchSpirVFrontEndContext* context);
  ...
  void GenerateEntryPoint(Zilch::GenericFunctionNode* node, ZilchShaderIRFunction* function, ZilchSpirVFrontEndContext* context);
  ...
  void WalkGenericLoop(Zilch::SyntaxNode* initializerNode, Zilch::SyntaxNode* iterator, Zilch::ConditionalLoopNode* conditionalNode, Zilch::LoopScopeNode* loopScopeNode, ZilchSpirVFrontEndContext* context);
  void GenerateLoopHeaderBlock(BasicBlock* headerBlock, BasicBlock* branchTarget, BasicBlock* mergeBlock, BasicBlock* continueBlock, ZilchSpirVFrontEndContext* context);
  void GenerateLoopConditionBlock(Zilch::ConditionalLoopNode* conditionalNode, BasicBlock* conditionBlock, BasicBlock* branchTrueBlock, BasicBlock* branchFalseBlock, ZilchSpirVFrontEndContext* context);
  void GenerateLoopStatements(Zilch::LoopScopeNode* loopScopeNode, BasicBlock* loopBlock, BasicBlock* mergeBlock, BasicBlock* continueBlock, ZilchSpirVFrontEndContext* context);
  void GenerateLoopContinueBlock(Zilch::SyntaxNode* iterator, BasicBlock* continueBlock, BasicBlock* headerBlock, ZilchSpirVFrontEndContext* context);
  ...
  bool ResolveSetter(Zilch::BinaryOperatorNode* node, ZilchShaderIROp* resultValue, Zilch::SyntaxNode* resultNode, ZilchSpirVFrontEndContext* context);
  ...
  IZilchShaderIR* PerformBinaryOp(Zilch::BinaryOperatorNode*& node, OpType opType, IZilchShaderIR* lhs, IZilchShaderIR* rhs, ZilchSpirVFrontEndContext* context);
  void PerformBinaryAssignmentOp(Zilch::BinaryOperatorNode*& node, OpType opType, ZilchSpirVFrontEndContext* context);
  void PerformBinaryAssignmentOp(Zilch::BinaryOperatorNode*& node, OpType opType, IZilchShaderIR* lhs, IZilchShaderIR* rhs, ZilchSpirVFrontEndContext* context);
  ...
  IZilchShaderIR* PerformUnaryIncDecOp(Zilch::UnaryOperatorNode*& node, IZilchShaderIR* constantOne, OpType opType, ZilchSpirVFrontEndContext* context);
  ...
  ZilchShaderIROp* AddSpecializationConstant(Zilch::MemberVariableNode* node, ZilchShaderIRType* varType, ZilchSpirVFrontEndContext* context);
  ...
  ZilchShaderIROp* AddSpecializationConstantRecursively(void* key, ZilchShaderIRType* varType, StringParam varName, ZilchShaderIRConstantLiteral* literalValue, Zilch::CodeLocation& codeLocation, ZilchSpirVFrontEndContext* context);
  ...
  ZilchShaderIROp* CreateSpecializationConstant(void* key, OpType opType, ZilchShaderIRType* varType, ZilchSpirVFrontEndContext* context);
  ...
  ZilchShaderIROp* BuildIROpNoBlockAdd(OpType opType, ZilchShaderIRType* resultType, ZilchSpirVFrontEndContext* context);
  ZilchShaderIROp* BuildIROp(BasicBlock* block, OpType opType, ZilchShaderIRType* resultType, ZilchSpirVFrontEndContext* context);
  ZilchShaderIROp* BuildIROp(BasicBlock* block, OpType opType, ZilchShaderIRType* resultType, IZilchShaderIR* arg0, ZilchSpirVFrontEndContext* context);
  ZilchShaderIROp* BuildIROp(BasicBlock* block, OpType opType, ZilchShaderIRType* resultType, IZilchShaderIR* arg0, IZilchShaderIR* arg1, ZilchSpirVFrontEndContext* context);
  ZilchShaderIROp* BuildIROp(BasicBlock* block, OpType opType, ZilchShaderIRType* resultType, IZilchShaderIR* arg0, IZilchShaderIR* arg1, IZilchShaderIR* arg2, ZilchSpirVFrontEndContext* context);
  ZilchShaderIROp* BuildCurrentBlockIROp(OpType opType, ZilchShaderIRType* resultType, ZilchSpirVFrontEndContext* context);
  ...
  ZilchShaderIROp* WalkAndGetValueTypeResult(BasicBlock* block, Zilch::SyntaxNode* node, ZilchSpirVFrontEndContext* context);
  ...
  ZilchShaderIROp* GetOrGenerateValueTypeFromIR(BasicBlock* block, IZilchShaderIR* instruction, ZilchSpirVFrontEndContext* context);
  ...
  ZilchShaderIROp* GetOrGeneratePointerTypeFromIR(BasicBlock* block, IZilchShaderIR* instruction, ZilchSpirVFrontEndContext* context);
  ...
  ZilchShaderIROp* GenerateFromBoolCast(BasicBlock* block, ZilchShaderIROp* source, ZilchShaderIRType* destType, IZilchShaderIR* zero, IZilchShaderIR* one, ZilchSpirVFrontEndContext* context);
  ZilchShaderIROp* GenerateIntegerToBoolCast(BasicBlock* block, ZilchShaderIROp* source, ZilchShaderIRType* destType, ZilchSpirVFrontEndContext* context);
  ZilchShaderIROp* GenerateToBoolCast(BasicBlock* block, OpType op, ZilchShaderIROp* source, ZilchShaderIRType* destType, IZilchShaderIR* zero, ZilchSpirVFrontEndContext* context);
  ...
  bool CheckForNonCopyableType(ZilchShaderIRType* shaderType, Zilch::ExpressionNode* node, ZilchSpirVFrontEndContext* context, bool generateDummyResult = true);
  ...
  bool ValidateResultType(IZilchShaderIR* instruction, ShaderIRTypeBaseType::Enum expectedType, Zilch::CodeLocation& codeLocation, bool throwException = true);
