...
void SimpleZilchParser::WalkStaticTypeOrCreationCallNode(Zilch::StaticTypeNode*& node, SimpleZilchParserContext* context)
{
  context->mBuilder << node->ReferencedType->Name;
}
void SimpleZilchParser::WalkExpressionInitializerNode(Zilch::ExpressionInitializerNode*& node, SimpleZilchParserContext* context)
{
...
void SimpleZilchParser::WalkGetterSetter(Zilch::MemberAccessNode*& node, Zilch::GetterSetter* getSet, SimpleZilchParserContext* context)
{
