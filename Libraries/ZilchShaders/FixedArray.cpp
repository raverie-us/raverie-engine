...
void FixedArrayExpressionInitializerResolver(ZilchSpirVFrontEnd* translator,
                                             ...
                                             ZilchSpirVFrontEndContext* context)
{
  ...
  ZilchShaderIROp* compositeConstructOp =
  ...
  for (size_t i = 0; i < node->InitializerStatements.Size(); ++i)
  {
    ...
    {
      Zilch::MemberAccessNode* memberAccessNode =
          Zilch::Type::DynamicCast<Zilch::MemberAccessNode*>(addCallNode->LeftOperand);
...
void FixedArrayResolver(ZilchSpirVFrontEnd* translator, Zilch::BoundType* zilchFixedArrayType)
{
  ...
  ZilchShaderIRType* fixedArrayType = translator->MakeTypeAndPointer(shaderLibrary,
  ...
  typeResolver.RegisterFunctionResolver(
      GetMemberOverloadedFunction(zilchFixedArrayType, Zilch::OperatorGet, intTypeName), ResolveFixedArrayGet);
  typeResolver.RegisterFunctionResolver(
      GetMemberOverloadedFunction(zilchFixedArrayType, Zilch::OperatorSet, intTypeName, zilchElementType->ToString()),
...
void RuntimeArrayResolver(ZilchSpirVFrontEnd* translator, Zilch::BoundType* zilchRuntimeArrayType)
{
  ...
  ZilchShaderIRType* runtimeArrayType = translator->MakeTypeAndPointer(
  ...
  typeResolver.RegisterFunctionResolver(
      GetMemberOverloadedFunction(zilchRuntimeArrayType, Zilch::OperatorGet, intTypeName), ResolveRuntimeArrayGet);
  typeResolver.RegisterFunctionResolver(
      GetMemberOverloadedFunction(zilchRuntimeArrayType, Zilch::OperatorSet, intTypeName, zilchElementType->ToString()),
      ResolveRuntimeArraySet);
  typeResolver.RegisterFunctionResolver(GetInstanceProperty(zilchRuntimeArrayType, "Count")->Get,
...
void GeometryStreamInputResolver(ZilchSpirVFrontEnd* translator, Zilch::BoundType* zilchInputStreamType)
{
  ...
  // Create the array type
  ZilchShaderIRType* inputStreamType = translator->MakeTypeAndPointer(shaderLibrary,
                                                                      ShaderIRTypeBaseType::FixedArray,
  ...
  typeResolver.mDefaultConstructorResolver = FixedArrayDefaultConstructor;
  typeResolver.RegisterFunctionResolver(
      GetMemberOverloadedFunction(zilchInputStreamType, Zilch::OperatorGet, intTypeName), ResolveFixedArrayGet);
  typeResolver.RegisterFunctionResolver(
      GetMemberOverloadedFunction(zilchInputStreamType, Zilch::OperatorSet, intTypeName, zilchElementType->ToString()),
      ResolveFixedArraySet);
  typeResolver.RegisterFunctionResolver(GetInstanceProperty(zilchInputStreamType, "Count")->Get,
...
void GeometryStreamOutputResolver(ZilchSpirVFrontEnd* translator, Zilch::BoundType* zilchFixedArrayType)
{
  ...
  ZilchShaderIRFunction* appendFn =
      translator->GenerateIRFunction(nullptr, nullptr, fixedArrayType, zilchAppendFn, zilchAppendFn->Name, context);
  ...
  typeResolver.mBackupConstructorResolver = FixedArrayBackupConstructor;
  typeResolver.mDefaultConstructorResolver = FixedArrayDefaultConstructor;
  typeResolver.RegisterFunctionResolver(GetMemberOverloadedFunction(zilchFixedArrayType, "Restart"),
                                        OutputStreamRestart);
  typeResolver.mExpressionInitializerListResolver = FixedArrayExpressionInitializerResolver;
}
