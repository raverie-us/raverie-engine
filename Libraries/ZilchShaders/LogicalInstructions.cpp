...
void ResolveLogicalBinaryOp(ZilchSpirVFrontEnd* translator,
...
template <OpType opType>
void ResolveLogicalUnaryOp(ZilchSpirVFrontEnd* translator,
...
void ResolveAnyAllNonZero(ZilchSpirVFrontEnd* translator,
...
void ResolveAllNonZero(ZilchSpirVFrontEnd* translator,
                       Zilch::FunctionCallNode* functionCallNode,
...
void ResolveAnyNonZero(ZilchSpirVFrontEnd* translator,
                       Zilch::FunctionCallNode* functionCallNode,
                       Zilch::MemberAccessNode* memberAccessNode,
                       ZilchSpirVFrontEndContext* context)
{
...
void ResolveLogicalOr(ZilchSpirVFrontEnd* translator,
                      Zilch::BinaryOperatorNode* binaryOpNode,
                      ZilchSpirVFrontEndContext* context)
{
...
void ResolveLogicalAnd(ZilchSpirVFrontEnd* translator,
                       Zilch::BinaryOperatorNode* binaryOpNode,
                       ZilchSpirVFrontEndContext* context)
{
