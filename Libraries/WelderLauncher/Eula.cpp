...
EulaWindow::EulaWindow(Cog* configCog, Composite* parent) : Composite(parent)
{
  ...
  eulaArea->SetLayout(CreateStackLayout(
      LayoutDirection::TopToBottom, Vec2::cZero, Thickness(23, 5, 23, 5)));
  {
    ...
    new Spacer(eulaArea, SizePolicy::Fixed, Pixels(0, 20));
    {
      ...
      // Set the font size (requires re-setting the color scheme for this to go
      // through...)
  ...
  bottom->SetLayout(CreateStackLayout(
      LayoutDirection::LeftToRight, Pixels(16, 0), Thickness(0, 0, 24, 0)));
  {
