...
void LineLayout::SetBracesHighlight(Scintilla::Range rangeLine, Position braces[],
...
void LineLayout::RestoreBracesHighlight(Scintilla::Range rangeLine, Position braces[], bool ignoreStyle) {
	if (!ignoreStyle && rangeLine.ContainsCharacter(braces[0])) {
		int braceOffset = braces[0] - rangeLine.start;
		if (braceOffset < numCharsInLine) {
