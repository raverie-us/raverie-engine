...
public:
  ...
  virtual bool KeyUp(Viewport* viewport, KeyboardEvent* event)
  {
    return false;
  }
  virtual bool MouseDown(Viewport* viewport, MouseEvent* event)
  {
    return false;
  }
  virtual bool MouseUp(Viewport* viewport, MouseEvent* event)
  {
    return false;
  }

  virtual bool RightMouseDown(Viewport* viewport, MouseEvent* event)
  {
    return false;
  }
  virtual bool RightMouseUp(Viewport* viewport, MouseEvent* event)
  {
    return false;
  }

  virtual bool MouseDoubleClick(Viewport* viewport, MouseEvent* event)
  {
    return false;
  }
  ...
  virtual bool MouseScroll(Viewport* viewport, MouseEvent* event)
  {
    return false;
  }
  ...
  virtual Composite* AddCustomUI(Composite* toolControl)
  {
    return nullptr;
  }
  virtual bool NeedsPropertyGrid()
  {
    return false;
  }
