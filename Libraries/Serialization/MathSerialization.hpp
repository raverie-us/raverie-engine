...
struct Policy<IntVec2>
{
  static inline bool Serialize(Serializer& stream,
                               ...
                               IntVec2& value)
  {
    return stream.ArrayField("Integer2",
                             fieldName,
                             (byte*)&value,
                             BasicArrayType::Integer,
                             2,
                             sizeof(int));
  }
};
...
struct Policy<IntVec3>
{
  static inline bool Serialize(Serializer& stream,
                               ...
                               IntVec3& value)
  {
    return stream.ArrayField("Integer3",
                             fieldName,
                             (byte*)&value,
                             BasicArrayType::Integer,
                             3,
...
struct Policy<IntVec4>
{
  static inline bool Serialize(Serializer& stream,
                               ...
                               IntVec4& value)
  {
    return stream.ArrayField("Integer4",
                             fieldName,
                             (byte*)&value,
                             BasicArrayType::Integer,
                             4,
...
struct Policy<Vec2>
{
  ...
  {
    return stream.ArrayField("Real2",
                             fieldName,
                             (byte*)&value,
                             BasicArrayType::Float,
                             2,
                             sizeof(float));
  }
};
...
struct Policy<Vec3>
{
  ...
  {
    return stream.ArrayField("Real3",
                             fieldName,
                             (byte*)&value,
                             BasicArrayType::Float,
                             3,
...
struct Policy<Vec4>
{
  ...
  {
    return stream.ArrayField("Real4",
                             fieldName,
                             (byte*)&value,
                             BasicArrayType::Float,
                             4,
...
struct Policy<Quat>
{
  ...
  {
    return stream.ArrayField("Quaternion",
                             fieldName,
                             (byte*)&value,
                             BasicArrayType::Float,
                             4,
...
struct Policy<Mat2>
{
  ...
  {
    return stream.ArrayField("Real2x2",
                             fieldName,
                             (byte*)&value,
                             BasicArrayType::Float,
                             4,
...
struct Policy<Mat3>
{
  ...
  {
    return stream.ArrayField("Real3x3",
                             fieldName,
                             (byte*)&value,
                             BasicArrayType::Float,
                             9,
...
struct Policy<Mat4>
{
  ...
  {
    return stream.ArrayField("Real4x4",
                             fieldName,
                             (byte*)&value,
                             BasicArrayType::Float,
                             16,
