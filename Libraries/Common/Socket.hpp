...
/// successful, else 0
ZeroShared Bits Serialize(SerializeDirection::Enum direction,
                          BitStream& bitStream,
...
/// platforms)
ZeroShared Array<SocketAddress> ResolveAllSocketAddresses(
    Status& status,
    StringParam host,
    StringParam service,
    SocketAddressFamily::Enum addressFamily,
...
ZeroShared Pair<String, String>
ResolveHostAndServiceNames(Status& status,
                           const SocketAddress& address,
                           SocketNameResolutionFlags::Enum nameResolutionFlags);
ZeroShared Pair<String, String>
ResolveHostAndServiceNames(Status& status, const SocketAddress& address);
...
ZeroShared String SocketAddressToString(Status& status,
                                        SocketAddressFamily::Enum addressFamily,
                                        const SocketAddress& address);
ZeroShared String SocketAddressToString(SocketAddressFamily::Enum addressFamily,
                                        const SocketAddress& address);
...
ZeroShared SocketAddress
StringToSocketAddress(Status& status,
                      SocketAddressFamily::Enum addressFamily,
                      StringParam address);
ZeroShared SocketAddress StringToSocketAddress(
    SocketAddressFamily::Enum addressFamily, StringParam address);
...
public:
  ...
  void GetSocketOption(Status& status,
  ...
  void SetSocketOption(Status& status,
                       SocketOption::Enum option,
                       const void* value,
                       size_t valueLength);
  void SetSocketOption(Status& status,
...
ZeroShared SocketAddress QueryLocalSocketAddress(Status& status,
                                                 const Socket& socket);
...
/// most platforms)
ZeroShared SocketAddress QueryRemoteSocketAddress(Status& status,
                                                  const Socket& socket);
