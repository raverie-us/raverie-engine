...
ZeroShared uint WriteToHex(char* buffer,
                           uint bufferSize,
                           u64 integerValue,
                           bool exclude0x = false);
ZeroShared uint WriteToHex(char* buffer,
                           uint bufferSize,
                           u32 integerValue,
                           bool exclude0x = false);
...
ZeroShared uint WriteToHexSize(char* buffer,
                               uint bufferSize,
                               uint places,
                               u64 integerValue,
                               bool exclude0x = false);
...
ZeroShared void ConvertUnicodeToAscii(char* destAscii,
                                      uint destAsciiLength,
...
ZeroShared uint ToBuffer(char* buffer,
                         uint bufferSize,
                         String value,
...
struct ZeroSharedTemplate has_global_to_value_helper
{
  ...
  static inline yes Test1(
      static_verify_function_signature<void (*)(StringRange, T2&), &ToValue>*);
  template <typename T2>
  ...
  template <typename T2>
  static inline yes
  Test2(static_verify_function_signature<void (*)(StringRange, T2&, int),
                                         &ToValue>*);
  template <typename T2>
  ...
  template <typename T2>
  static inline yes
  Test3(static_verify_function_signature<void (*)(StringRangeParam, T2&),
                                         &ToValue>*);
  template <typename T2>
  ...
  template <typename T2>
  static inline yes
  Test4(static_verify_function_signature<void (*)(StringRangeParam, T2&, int),
                                         &ToValue>*);
  template <typename T2>
...
template <typename T>
struct ZeroSharedTemplate has_global_to_value
    : public integral_constant<bool, has_global_to_value_helper<T>::value>
{
};
...
struct ZeroSharedTemplate has_global_to_buffer_helper
{
  ...
  template <typename T2>
  static inline yes
  Test(static_verify_function_signature<uint (*)(char*, uint, T2, bool),
                                        &ToBuffer>*);
  template <typename T2>
...
/// else defined as false
template <typename T>
struct ZeroSharedTemplate has_global_to_buffer
    : public integral_constant<bool, has_global_to_buffer_helper<T>::value>
{
};
