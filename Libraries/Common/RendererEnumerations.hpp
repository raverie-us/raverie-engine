...
/// values (destination). <param name="Add">Source is added to
/// destination.</param> <param name="Subtract">Source is subtracted from
/// destination.</param> <param name="ReverseSubtract">Destination is subtracted
/// from source.</param> <param name="Min">The minimum value between source and
/// destination is kept.</param> <param name="Max">The maximum value between
/// source and destination is kept.</param>
...
/// <param name="InvDestColor">One minus the RGB of the destination
/// value.</param> <param name="SourceAlpha">The alpha channel of the source
/// value.</param> <param name="InvSourceAlpha">One minus the alpha channel of
/// the source value.</param> <param name="DestAlpha">The alpha channel of the
/// destination value.</param> <param name="InvDestAlpha">One minus the alpha
...
/// <param name="Enabled">Blending is used, color and alpha use the same
/// equations.</param> <param name="Separate">Blending is used, color and alpha
/// use separate equations.</param>
...
/// name="FrontFace">Counter clockwise triangles are not rendered.</param>
...
/// <param name="Write">Depth values are compared to the depth buffer, if
/// comparison succeeds the new value is written to the buffer.</param>
...
/// <param name="GraphicalSortValue">Uses the sort value on the graphical
/// component, lowest to highest.</param> <param name="SortEvent">An event is
/// sent on CameraViewport every frame for custom logic to determine the sort
/// value.</param> <param name="BackToFrontView">Uses the distance in the view
/// direction, furthest to nearest.</param> <param name="FrontToBackView">Uses
/// the distance in the view direction, nearest to furthest.</param> <param
/// name="NegativeToPositiveX">Uses the world space X-coordinate.</param> <param
/// name="PositiveToNegativeX">Uses the world space X-coordinate.</param> <param
/// name="NegativeToPositiveY">Uses the world space Y-coordinate.</param> <param
/// name="PositiveToNegativeY">Uses the world space Y-coordinate.</param> <param
/// name="NegativeToPositiveZ">Uses the world space Z-coordinate.</param> <param
/// name="PositiveToNegativeZ">Uses the world space Z-coordinate.</param>
DeclareEnum11(GraphicalSortMethod,
              None,
              GraphicalSortValue,
              SortEvent,
              BackToFrontView,
...
/// <param name="Perspective">Projection towards a single view point, making
/// distant objects appear smaller.</param> <param
/// name="Orthographic">Projection is parallel with the viewing
/// direction.</param>
...
/// <param name="Enabled">Stencil values will be tested with the active
/// settings.</param> <param name="Separate">Stencil values will be tested,
/// frontface/backface triangles will use separate settings.</param>
...
/// <param name="LessEqual">Compares if test value is less than or equal to
/// buffer value.</param> <param name="Greater">Compares if test value is
/// greater than buffer value.</param> <param name="GreaterEqual">Compares if
...
/// <param name="LargestMultiple">Viewport is the largest multiple of the set
