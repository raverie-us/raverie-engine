...
enum Enum
{
  ...
  AnyAddress =
      0x00000001, /// Given an empty host, the host will resolve to the 'any'
  ...
  RequestIpv6and4 = 0x00000100,   /// Request both IPv6 and IPv4 addresses with
                                  /// RequestIpv4Mapped
  ResolveIfGlobalAddress =
      0x00000400, /// Resolves only if a global address is configured
  ...
  ResolveSecure =
      0x00008000, /// Enable address resolution from a secure channel
  RequestPreferredNames =
      0x00010000, /// Request address resolution for a preferred user name
  ...
  FileServerHint =
      0x00040000, /// Hint that the host being queried is a file server
  DisableInternationalNames =
      0x00080000 /// Disable internationalized domain name handling
};
typedef uint Type;
} // namespace SocketAddressResolutionFlags
...
enum Enum
{
  ...
  Ipv6FragmentHeader =
      44, /// Internet Protocol Version 6 (IPv6) Fragment Header
  IpSecEncapsulatingSecurityPayload =
      50, /// Internet Protocol Security Encapsulating Security Payload
  IpSecAuthenticationHeader =
      51,      /// Internet Protocol Security Authentication Header
  ...
  Ipv6DestinationOptions =
      60,       /// Internet Protocol Version 6 (IPv6) Destination Options
...
enum Enum
{
  ...
  SendLoopback =
      0x0040,      /// Send data using the loopback adapter? (Get/Set : bool)
  ...
  OutOfBandInline = 0x0100, /// Return Out-Of-Band data inline with regular
                            /// data? (Get/Set : bool)
  DontLinger =
      ~Linger, /// Socket should remain open for a set duration after being
  ...
  SendBufferSize =
      0x1001, /// Socket buffer size reserved for sending data (Get/Set : uint)
  ...
  ProviderConfig =
      0x3001, /// Socket service provider configuration (Get/Set : char*)
  ConditionalAccept =
      0x3002, /// Accept/reject incoming connections by the application? Valid
  ...
  RandomizePort =
      0x3005, /// Randomize wildcard port assignment (Get/Set : bool)
...
enum Enum
{
  ...
  TimeToLive =
      4, /// Time To Live (TTL, aka hop limit) of packets (Get/Set : uint)
  ...
  MulticastLoopback =
      11, /// Allow local, outgoing multicast data to be received using the
          /// loopback adapter? (Get/Set : bool)
  AddMulticastGroupMembership =
      12, /// Add membership to the specified multicast group (Set : ip_mreq)
  ...
  DontFragment = 14, /// Don't fragment messages. Valid for message-oriented
                     /// protocols (Get/Set : bool)
  AddMulticastGroupAndSourceMembership =
      15, /// Add membership to the specified multicast group and accept data
          /// from the supplied multicast source address (Set : ip_mreq_source)
  RemoveMulticastGroupAndSourceMembership =
      16, /// Remove membership from the specified multicast group and ignore
          /// data from the supplied multicast source address (Set :
          /// ip_mreq_source)
  RemoveMulticastSourceMembership =
      17, /// Ignore data from the supplied multicast source address (Set :
          /// ip_mreq_source)
  AddMulticastSourceMembership = 18, /// Accept data from the supplied multicast
                                     /// source address (Set : ip_mreq_source)
  ReturnPacketInfo =
      19, /// Return the packet information when a packet is received, in the
          /// WSAMSG structure returned by WSARecvMsg? Valid only for datagram
          /// or raw sockets (Get/Set : bool)
  ReturnTimeToLive =
      21, /// Return the Time To Live (TTL, aka hop limit) when a packet is
  ...
  ReturnArrivalInterface =
      24, /// Return the arrival interface when a packet is received, in the
          /// WSAMSG structure returned by WSARecvMsg? Valid only for datagram
          /// or raw sockets (Get/Set : bool)
  ReturnDestinationAddress =
      25, /// Return the destination address when a packet is received, in the
          /// WSAMSG structure returned by WSARecvMsg? Valid only for datagram
          /// or raw sockets (Get/Set : bool)
  ...
  ReturnRoutingHeader =
      38, /// Return the routing header when a packet is received, in the WSAMSG
          /// structure returned by WSARecvMsg? Valid only for datagram or raw
          /// sockets (Get/Set : bool)
  TrafficClass = 39, /// Packet traffic class
  ReturnTrafficClass =
      40, /// Return the packet traffic class when a packet is received, in the
          /// WSAMSG structure returned by WSARecvMsg? Valid only for datagram
          /// or raw sockets (Get/Set : bool)
  ReturnOriginalArrivalInterface =
      47 /// Return the original arrival interface when a packet is received, in
...
enum Enum
{
  ...
  MulticastLoopback =
      11, /// Allow local, outgoing multicast data to be received using the
          /// loopback adapter? (Get/Set : bool)
  AddMulticastGroupMembership =
      12, /// Add membership to the specified multicast group (Set : ipv6_mreq)
  RemoveMulticastGroupMembership = 13, /// Remove membership from the specified
  ...
  ReturnTimeToLive =
      21, /// Return the Time To Live (TTL, aka hop limit) when a packet is
          ...
          /// only for datagram or raw sockets (Get/Set : bool)
  ProtectionLevel =
      23, /// Restrict the scope of a listening socket (Get/Set : int)
  ReturnArrivalInterface =
      24, /// Return the arrival interface when a packet is received, in the
          /// WSAMSG structure returned by WSARecvMsg? Valid only for datagram
          /// or raw sockets (Get/Set : bool)
...
enum Enum
{
  ...
  RetransmitDurationBeforeClose =
      5, /// Retransmit duration, in seconds, before the connection is closed
         /// (Get/Set : uint)
...
static const InternetProtocol::Enum InternetProtocolMin =
    InternetProtocol::Unspecified;
static const InternetProtocol::Enum InternetProtocolMax =
