...
public:
  ...
  Atomic& operator=(value_type value)
  {
    Store(value);
    return *this;
  }
  Atomic& operator=(value_type value) volatile
  {
    Store(value);
    return *this;
  }
  Atomic& operator=(const Atomic& rhs) volatile
  {
    Store(rhs.mValue);
    return *this;
  }
  ...
  {
    AtomicStore(&mValue, reinterpret_cast<underlying_type&>(value));
  }
  ...
  {
    underlying_type result = AtomicLoad(const_cast<underlying_type*>(&mValue));
  ...
  value_type operator++()
  {
    underlying_type result = AtomicPreIncrement(&mValue);
    return reinterpret_cast<value_type&>(result);
  }
  ...
  {
    underlying_type result = AtomicPostIncrement(&mValue);
    return reinterpret_cast<value_type&>(result);
  }
  ...
  value_type operator--()
  {
    underlying_type result = AtomicPreDecrement(&mValue);
    return reinterpret_cast<value_type&>(result);
  }
  value_type operator--() volatile
  {
  ...
  value_type operator--(int)
  {
    underlying_type result = AtomicPostDecrement(&mValue);
    return reinterpret_cast<value_type&>(result);
  }
  value_type operator--(int) volatile
  {
