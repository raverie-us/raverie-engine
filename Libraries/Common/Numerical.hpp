...
/// last parameter.
ZeroShared uint
SolveQuartic(real a0, real a1, real a2, real a3, real a4, real* roots);
...
ZeroShared real
EvaluateQuartic(real x, real a0, real a1, real a2, real a3, real a4);

/// Evaluates the polynomial at the given x-value.
///             a[count] * x^(count) + ... + a[1] * x + a[0]
ZeroShared real EvaluatePolynomial(real x,
                                   real* coefficients,
