...
extern int vsprintf_s(char* buffer,
...
extern int
swprintf_s(wchar_t* buffer, size_t sizeOfBuffer, const wchar_t* format, ...);
...
#define ZeroSPrintfCount(format, ...)                                          \
  snprintf(gDiscardBuffer, 1, format, __VA_ARGS__)
