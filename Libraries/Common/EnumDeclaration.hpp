...
#define _ExpandNames6(                                                         \
    name, mode, value1, value2, value3, value4, value5, value6)                \
  namespace name                                                               \
  {                                                                            \
  typedef uint Type;                                                           \
  static const cstr EnumName = #name;                                          \
...
#define _ExpandNames7(                                                         \
    name, mode, value1, value2, value3, value4, value5, value6, value7)        \
  namespace name                                                               \
  {                                                                            \
  typedef uint Type;                                                           \
  static const cstr EnumName = #name;                                          \
  ...
  static const cstr Names[] = {                                                \
      #value1, #value2, #value3, #value4, #value5, #value6, #value7, NULL};    \
  static const uint Values[] = {                                               \
      value1, value2, value3, value4, value5, value6, value7};                 \
  }

#define _ExpandNames8(name,                                                    \
                      mode,                                                    \
                      value1,                                                  \
                      value2,                                                  \
                      value3,                                                  \
...
#define _ExpandNames23(name,                                                   \
  ...
  static const cstr Names[] = {                                                \
      ...
      #value7,  #value8,  #value9,  #value10, #value11, #value12,              \
      #value13, #value14, #value15, #value16, #value17, #value18,              \
      #value19, #value20, #value21, #value22, #value23, NULL};                 \
  static const uint Values[] = {                                               \
      value1,  value2,  value3,  value4,  value5,  value6,  value7,  value8,   \
      value9,  value10, value11, value12, value13, value14, value15, value16,  \
...
#define _ExpandNames25(name,                                                   \
  ...
  static const cstr Names[] = {                                                \
      ...
      #value8,  #value9,  #value10, #value11, #value12, #value13, #value14,    \
      #value15, #value16, #value17, #value18, #value19, #value20, #value21,    \
      #value22, #value23, #value24, #value25, NULL};                           \
  static const uint Values[] = {value1,  value2,  value3,  value4,  value5,    \
                                value6,  value7,  value8,  value9,  value10,   \
                                value11, value12, value13, value14, value15,   \
                                value16, value17, value18, value19, value20,   \
...
#define _ExpandNames26(name,                                                   \
  ...
  static const cstr Names[] = {                                                \
      ...
      #value8,  #value9,  #value10, #value11, #value12, #value13, #value14,    \
      #value15, #value16, #value17, #value18, #value19, #value20, #value21,    \
      #value22, #value23, #value24, #value25, #value26, NULL};                 \
  static const uint Values[] = {                                               \
      value1,  value2,  value3,  value4,  value5,  value6,  value7,            \
      value8,  value9,  value10, value11, value12, value13, value14,           \
      value15, value16, value17, value18, value19, value20, value21,           \
...
#define _ExpandNames27(name,                                                   \
  ...
  static const uint Values[] = {                                               \
      ...
      value8,  value9,  value10, value11, value12, value13, value14,           \
      value15, value16, value17, value18, value19, value20, value21,           \
      value22, value23, value24, value25, value26, value27};                   \
  }
...
#define _ExpandNames32(name,                                                   \
  ...
  static const cstr Names[] = {                                                \
      ...
      #value15, #value16, #value17, #value18, #value19, #value20, #value21,    \
      #value22, #value23, #value24, #value25, #value26, #value27, #value28,    \
      #value29, #value30, #value31, #value32, NULL};                           \
  static const uint Values[] = {                                               \
      value1,  value2,  value3,  value4,  value5,  value6,  value7,  value8,   \
      value9,  value10, value11, value12, value13, value14, value15, value16,  \
      value17, value18, value19, value20, value21, value22, value23, value24,  \
...
#define DeclareEnum12(name, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12) \
  _ExpandNames12(                                                              \
      name, _Indexed(), v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12)
#define DeclareEnum13(                                                         \
...
#define DeclareBitField1(name, v1)                                             \
  _ExpandNames1(name, _BitField(), v1) _AddNone(name)
#define DeclareBitField2(name, v1, v2)                                         \
  _ExpandNames2(name, _BitField(), v1, v2) _AddNone(name)
#define DeclareBitField3(name, v1, v2, v3)                                     \
  _ExpandNames3(name, _BitField(), v1, v2, v3) _AddNone(name)
#define DeclareBitField4(name, v1, v2, v3, v4)                                 \
  _ExpandNames4(name, _BitField(), v1, v2, v3, v4) _AddNone(name)
#define DeclareBitField5(name, v1, v2, v3, v4, v5)                             \
  _ExpandNames5(name, _BitField(), v1, v2, v3, v4, v5) _AddNone(name)
...
#define DeclareBitField11(name, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11)  \
  _ExpandNames11(                                                              \
      name, _BitField(), v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11)         \
      _AddNone(name)
#define DeclareBitField12(                                                     \
    name, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12)                   \
  _ExpandNames12(                                                              \
      name, _BitField(), v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12)    \
      _AddNone(name)
#define DeclareBitField13(                                                     \
    name, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13)              \
  _ExpandNames13(name,                                                         \
                 _BitField(),                                                  \
                 v1,                                                           \
