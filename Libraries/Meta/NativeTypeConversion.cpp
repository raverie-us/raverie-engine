...
NativeType* ZilchTypeToBasicNativeType(Zilch::Type* zilchType)
{
  ...
  // Boolean type?
           ...
           ZilchTypeId(BasicNativeTypeFromEnum<BasicNativeType::Bool>::Type))
    return NativeTypeOf(BasicNativeTypeFromEnum<BasicNativeType::Bool>::Type);

  // Integer type?
  else if (zilchType ==
           ZilchTypeId(BasicNativeTypeFromEnum<BasicNativeType::Int32>::Type))
    return NativeTypeOf(BasicNativeTypeFromEnum<BasicNativeType::Int32>::Type);
  // DoubleInteger type?
  else if (zilchType ==
           ZilchTypeId(BasicNativeTypeFromEnum<BasicNativeType::Int64>::Type))
    return NativeTypeOf(BasicNativeTypeFromEnum<BasicNativeType::Int64>::Type);

  // Byte type?
  else if (zilchType ==
           ZilchTypeId(BasicNativeTypeFromEnum<BasicNativeType::Uint8>::Type))
    return NativeTypeOf(BasicNativeTypeFromEnum<BasicNativeType::Uint8>::Type);

  // Real type?
  else if (zilchType ==
           ZilchTypeId(BasicNativeTypeFromEnum<BasicNativeType::Float>::Type))
    return NativeTypeOf(BasicNativeTypeFromEnum<BasicNativeType::Float>::Type);
  // DoubleReal type?
  else if (zilchType ==
           ZilchTypeId(BasicNativeTypeFromEnum<BasicNativeType::Double>::Type))
    return NativeTypeOf(BasicNativeTypeFromEnum<BasicNativeType::Double>::Type);

  // Boolean2 type?
  else if (zilchType ==
           ZilchTypeId(
               BasicNativeTypeFromEnum<BasicNativeType::BoolVector2>::Type))
    return NativeTypeOf(
        BasicNativeTypeFromEnum<BasicNativeType::BoolVector2>::Type);
  // Boolean3 type?
  else if (zilchType ==
           ZilchTypeId(
               BasicNativeTypeFromEnum<BasicNativeType::BoolVector3>::Type))
    return NativeTypeOf(
        BasicNativeTypeFromEnum<BasicNativeType::BoolVector3>::Type);
  // Boolean4 type?
  else if (zilchType ==
           ZilchTypeId(
               BasicNativeTypeFromEnum<BasicNativeType::BoolVector4>::Type))
    return NativeTypeOf(
        BasicNativeTypeFromEnum<BasicNativeType::BoolVector4>::Type);
  ...
  // Integer2 type?
           ...
           ZilchTypeId(
               BasicNativeTypeFromEnum<BasicNativeType::IntVector2>::Type))
    return NativeTypeOf(
        BasicNativeTypeFromEnum<BasicNativeType::IntVector2>::Type);
  // Integer3 type?
  else if (zilchType ==
           ZilchTypeId(
               BasicNativeTypeFromEnum<BasicNativeType::IntVector3>::Type))
    return NativeTypeOf(
        BasicNativeTypeFromEnum<BasicNativeType::IntVector3>::Type);
  // Integer4 type?
  else if (zilchType ==
           ZilchTypeId(
               BasicNativeTypeFromEnum<BasicNativeType::IntVector4>::Type))
    return NativeTypeOf(
        BasicNativeTypeFromEnum<BasicNativeType::IntVector4>::Type);

  // Real2 type?
  else if (zilchType ==
           ZilchTypeId(BasicNativeTypeFromEnum<BasicNativeType::Vector2>::Type))
    return NativeTypeOf(
        BasicNativeTypeFromEnum<BasicNativeType::Vector2>::Type);
  // Real3 type?
  else if (zilchType ==
           ZilchTypeId(BasicNativeTypeFromEnum<BasicNativeType::Vector3>::Type))
    return NativeTypeOf(
        BasicNativeTypeFromEnum<BasicNativeType::Vector3>::Type);
  // Real4 type?
  else if (zilchType ==
           ZilchTypeId(BasicNativeTypeFromEnum<BasicNativeType::Vector4>::Type))
    return NativeTypeOf(
        BasicNativeTypeFromEnum<BasicNativeType::Vector4>::Type);

  // Quaternion type?
  else if (zilchType ==
           ZilchTypeId(
               BasicNativeTypeFromEnum<BasicNativeType::Quaternion>::Type))
    return NativeTypeOf(
        BasicNativeTypeFromEnum<BasicNativeType::Quaternion>::Type);

  // Real3x3 type?
  else if (zilchType ==
           ZilchTypeId(BasicNativeTypeFromEnum<BasicNativeType::Matrix3>::Type))
    return NativeTypeOf(
        BasicNativeTypeFromEnum<BasicNativeType::Matrix3>::Type);
  // Real4x4 type?
  else if (zilchType ==
           ZilchTypeId(BasicNativeTypeFromEnum<BasicNativeType::Matrix4>::Type))
    return NativeTypeOf(
        BasicNativeTypeFromEnum<BasicNativeType::Matrix4>::Type);

  // String type?
  else if (zilchType ==
           ZilchTypeId(BasicNativeTypeFromEnum<BasicNativeType::String>::Type))
...
Zilch::Type* BasicNativeTypeToZilchType(NativeType* nativeType)
{
  ...
  NativeTypeId nativeTypeId =
      nativeType ? nativeType->mTypeId : cInvalidNativeTypeId;
...
Zilch::Type* BasicNativeTypeToZilchType(NativeTypeId nativeTypeId)
{
  ...
  case BasicNativeType::Bool:
    return ZilchTypeId(
        BasicNativeTypeFromEnum<BasicNativeType::Bool>::Type); // Boolean type
  ...
  case BasicNativeType::Int32:
    return ZilchTypeId(
        BasicNativeTypeFromEnum<BasicNativeType::Int32>::Type); // Integer type
  case BasicNativeType::Int64:
    return ZilchTypeId(
        BasicNativeTypeFromEnum<BasicNativeType::Int64>::Type); // DoubleInteger
                                                                // type

  // Fixed-Width Unsigned Integral Types
  case BasicNativeType::Uint8:
    return ZilchTypeId(
        BasicNativeTypeFromEnum<BasicNativeType::Uint8>::Type); // Byte type
  ...
  case BasicNativeType::Float:
    return ZilchTypeId(
        BasicNativeTypeFromEnum<BasicNativeType::Float>::Type); // Real type
  case BasicNativeType::Double:
    return ZilchTypeId(
        BasicNativeTypeFromEnum<BasicNativeType::Double>::Type); // DoubleReal
                                                                 // type
  ...
  case BasicNativeType::IntVector3:
    return ZilchTypeId(
        BasicNativeTypeFromEnum<BasicNativeType::IntVector3>::Type); // Integer3
                                                                     // type
  case BasicNativeType::IntVector4:
    return ZilchTypeId(
        BasicNativeTypeFromEnum<BasicNativeType::IntVector4>::Type); // Integer4
                                                                     // type
  case BasicNativeType::Vector2:
    return ZilchTypeId(
        BasicNativeTypeFromEnum<BasicNativeType::Vector2>::Type); // Real2 type
  case BasicNativeType::Vector3:
    return ZilchTypeId(
        BasicNativeTypeFromEnum<BasicNativeType::Vector3>::Type); // Real3 type
  ...
  case BasicNativeType::Matrix4:
    return ZilchTypeId(
        BasicNativeTypeFromEnum<BasicNativeType::Matrix4>::Type); // Real4x4
                                                                  // type

  // String Type
  case BasicNativeType::String:
    return ZilchTypeId(
        BasicNativeTypeFromEnum<BasicNativeType::String>::Type); // String type
  }
}
