...
{
  return IntVec3::cZero;
}
IntVec4 GetDefaultValue(IntVec4* dummy)
{
  return IntVec4::cZero;
}
...
Mat3 GetDefaultValue(Mat3* dummy)
{
  return Mat3::cIdentity;
}
Mat4 GetDefaultValue(Mat4* dummy)
{
