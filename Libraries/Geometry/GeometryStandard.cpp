...
ZilchDefineExternalBaseType(Ray, TypeCopyMode::ValueType, builder, type)
{
  ...
  ZilchFullBindConstructor(
      builder, type, ZilchSelf, "start, direction", Vec3Param, Vec3Param);

  ZilchBindMemberProperty(Start);
  ZilchBindMemberProperty(Direction);
  ZilchFullBindMethod(
      builder, type, &Ray::GetPoint, ZilchNoOverload, "GetPoint", "tValue")
      ->Description =
      ZilchDocumentString("Returns the point at the given t-value.");
  ZilchFullBindMethod(
      builder, type, &Ray::GetTValue, ZilchNoOverload, "GetTValue", "point")
      ->Description =
...
ZilchDefineExternalBaseType(Segment, TypeCopyMode::ValueType, builder, type)
{
  ZilchBindDefaultCopyDestructor();
  ZilchFullBindConstructor(
      builder, type, ZilchSelf, "start, end", Vec3Param, Vec3Param);

  ZilchBindMemberProperty(Start);
  ZilchBindMemberProperty(End);
  ZilchFullBindMethod(
      builder, type, &Segment::GetPoint, ZilchNoOverload, "GetPoint", "tValue")
      ->Description =
      ZilchDocumentString("Returns the point at the given t-value.");
  ZilchFullBindMethod(
      builder, type, &Segment::GetTValue, ZilchNoOverload, "GetTValue", "point")
      ->Description =
      ZilchDocumentString("Returns the t-value that would result in the given "
...
ZilchDefineExternalBaseType(Sphere, TypeCopyMode::ValueType, builder, type)
{
  ZilchBindDefaultCopyDestructor();
  ZilchFullBindConstructor(
      builder, type, ZilchSelf, "center, radius", Vec3Param, real);

  ZilchBindMemberProperty(mCenter);
  ZilchBindMemberProperty(mRadius);
  ZilchBindOverloadedMethodAs(
      Expand, ZilchStaticOverload(Sphere, const Sphere&, Vec3Param), "Expand")
      ->Description = ZilchDocumentString(
  ...
  ZilchBindMethodAs(Overlap, "Overlaps")->Description = ZilchDocumentString(
...
ZilchDefineExternalBaseType(Plane, TypeCopyMode::ValueType, builder, type)
{
  ...
  ZilchFullBindConstructor(
      builder, type, ZilchSelf, "normal point", Vec3Param, Vec3Param);
  ZilchFullBindMethod(builder,
                      type,
                      &ZilchSelf::Set,
                      ZilchInstanceOverload(void, Vec4Param),
                      "Set",
                      "data");
  ZilchFullBindMethod(builder,
                      type,
                      &ZilchSelf::Set,
                      ZilchInstanceOverload(void, Vec3Param, Vec3Param),
                      "Set",
                      "normal point");
...
ZilchDefineExternalBaseType(Frustum, TypeCopyMode::ValueType, builder, type)
{
  ...
  ZilchBindOverloadedMethod(Set,
                            ZilchInstanceOverload(void, uint, const Plane&));
