...
const Vec3 cTruncatedDodecahedron[60] = {
    Vec3(zero, oot, TpT), Vec3(zero, oot, -TpT), Vec3(zero, -oot, TpT), Vec3(zero, -oot, -TpT),

    Vec3(TpT, zero, oot), Vec3(TpT, zero, -oot), Vec3(-TpT, zero, oot), Vec3(-TpT, zero, -oot),
...
const Vec3 cRhombicosidodecahedron[60] = {
    ...
    Vec3(tsq, tpt, zero), Vec3(tsq, -tpt, zero), Vec3(-tsq, tpt, zero), Vec3(-tsq, -tpt, zero),

    Vec3(zero, tsq, tpt), Vec3(zero, tsq, -tpt), Vec3(zero, -tsq, tpt), Vec3(zero, -tsq, -tpt)};
