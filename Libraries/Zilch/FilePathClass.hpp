...
public:
  ZilchDocument(FilePathClass,
                "A helper class for building file paths and extracting "
                "information from file paths");
  ZilchDeclareType(FilePathClass, TypeCopyMode::ReferenceType);

  ZilchDocument(CombineDirectories,
                "Combines directory paths and directories names together (empty entries "
                "are skipped). "
                "This will always include a directory separator at the end of the "
                "result.\n"
                "Example: ('Content', 'Powerups') results in 'Content\\Powerups\\'\n"
                "Example: ('Content\\', 'Powerups\\') results in 'Content\\Powerups\\'\n"
                "Example: ('Content\\', '', 'Powerups') results in "
                "'Content\\Powerups\\'\n"
                "Example: ('C:\\Sandbox\\', 'Content') results in "
                "'C:\\Sandbox\\Content\\'\n");
  ...
  static String
  CombineDirectories(StringParam dir0, StringParam dir1, StringParam dir2, StringParam dir3, StringParam dir4);

  ZilchDocument(CombineDirectoriesAndFile,
                "Combines directory paths, directories names, and a single "
                "file name together (empty entries are skipped). "
                "Because we are combining a file name at the end, this will "
                "not result in a trailing directory separator.\n"
                "Example: ('Content\\Powerups\\', 'Recharge.png') results in "
                "'Content\\Powerups\\Recharge.png'\n"
                "Example: ('Content\\Powerups', '', 'Recharge.png') results in "
                "'Content\\Powerups\\Recharge.png'\n"
                "Example: ('Content', 'Powerups', 'Recharge.png') results in "
                "'Content\\Powerups\\Recharge.png'\n"
                "Example: ('C:\\Sandbox\\', 'Content\\Player.png') results in "
                "'C:\\Sandbox\\Content\\Player.png'\n");
  ...
  static String CombineDirectoriesAndFile(
  ...
  ZilchDocument(DirectorySeparator,
                ...
                "This value is often different depending on the operating system "
                "(generally either '/' or '\\')\n");
  static String GetDirectorySeparator();

  ZilchDocument(ChangeExtension,
                "Changes the extension of a path (with file name at the end) to a new "
                "extension. "
                "If the file has no extension, then this will automatically add the "
                "extension to the end. "
                "The extension is allowed to contain a leading dot '.' character (or "
                "not). "
                "The path is also allowed to contain a trailing dot '.' character (or "
                "not).\n"
                "Example: ('Content\\Player.png', 'jpg') results in "
                "'Content\\Player.jpg'\n"
                "Example: ('Content\\Player', 'jpg') results in 'Content\\Player.jpg'\n"
                "Example: ('Content\\Player.', '.jpg') results in "
                "'Content\\Player.jpg'\n");
  static String ChangeExtension(StringParam path, StringParam extension);

  ZilchDocument(GetExtensionWithDot,
                "Returns only the extension of a file (everything after the last dot, "
                "including the dot). "
  ...
  ZilchDocument(GetFileNameWithExtension,
                "Returns only the file portion of a path (everything past the "
                "last separator including the extension).\n"
  ...
  ZilchDocument(GetFileNameWithoutExtension,
                "Returns only the file portion of a path (everything past the "
                "last separator excluding the extension).\n"
  ...
  ZilchDocument(AddTrailingDirectorySeparator,
                "Pass in a directory path with or without the separator and this will "
                "add it at the end (if needed).\n"
                "Example: ('Content\\Powerups') results in 'Content\\Powerups\\'\n"
                "Example: ('Content\\Powerups\\') results in 'Content\\Powerups\\'\n");
  ...
  ZilchDocument(RemoveTrailingDirectorySeparator,
                "Pass in a directory path with or without the separator and this will "
                "remove it from the end (if needed).\n"
                "Example: ('Content\\Powerups') results in 'Content\\Powerups'\n"
                "Example: ('Content\\Powerups\\') results in 'Content\\Powerups'\n");
  ...
  ZilchDocument(GetDirectoryPath,
                ...
                "If a directory path is passed in (ending in a separator), this will "
                "return the directy back with no modifications. "
                "A directory path without a trailing separator is abiguous with a file "
                "that has no extension. "
                "This will always include a directory separator at the end of the "
                "result. "
                "In this case, we always assume it is a file and therefore get the "
  ...
  ZilchDocument(GetDirectoryName,
                "If a file path is passed in, this will return the name of the parent "
                "directory. "
                "If a directory path is passed in (ending in a separator), this will "
  ...
  ZilchDocument(GetCanonicalizedPathFromAbsolutePath,
                "Changes all directory separators to be the current operating "
                "system directory separator, removes duplicate separators, and "
                "removes '..' and '.' from the paths. "
                "Canonicalized is only guaranteed to work on absolute paths. "
                "This behavior is operating system dependent and may call the "
                "related OS functions.\n"
                "Example: ('C:/Sandbox//Engine/../Content/./Player.png') "
                "results in 'C:\\Sandbox\\Content\\Player.png'\n");
  ...
  ZilchDocument(GetComparablePathFromAbsolutePath,
                "First this normalizes the path, then if the operating system is case "
                "insensative, it will make the path all lowercase so that it compares.\n"
                "Example: ('C:\\Sandbox\\Engine\\..\\Content\\.\\Player.png') results in "
                "'c:\\sandbox\\content\\player.png'\n");
  static String GetComparablePathFromAbsolutePath(StringParam path);

  ZilchDocument(IsRelative,
                "Returns true if a path has no root (such as a volume/hard drive "
                "specifier, or unix like systems a beginning slash). "
                "Even a beginning slash that means 'relative to the current working "
                "directory volume' is still relative. "
  ...
  ZilchDocument(WorkingDirectory,
                ...
                "In general the changing of the working directory is discouraged because "
                "it may affect assumptions of the host application. "
                "This will always include a directory separator at the end of the "
                "result.\n");
  ...
  ZilchDocument(UserDocumentsDirectory,
                ...
                "here (read/write/create permissions should be allowed). "
                "This will always include a directory separator at the end of the "
                "result.\n");
  ...
  ZilchDocument(ExecutableFile, "A path directly to the executable itself (exe, elf...).\n");
