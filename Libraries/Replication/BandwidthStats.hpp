...
public:
  ...
  Kbps GetMinOutgoingBandwidthUsage() const
  {
    return mOutgoingBandwidthUsageMin;
  }
  /// Returns the average outgoing bandwidth usage
  Kbps GetAvgOutgoingBandwidthUsage() const
  {
    return mOutgoingBandwidthUsageAvg;
  }
  /// Returns the maximum outgoing bandwidth usage
  Kbps GetMaxOutgoingBandwidthUsage() const
  {
    return mOutgoingBandwidthUsageMax;
  }

  /// Returns the minimum incoming bandwidth usage
  Kbps GetMinIncomingBandwidthUsage() const
  {
    return mIncomingBandwidthUsageMin;
  }
  /// Returns the average incoming bandwidth usage
  Kbps GetAvgIncomingBandwidthUsage() const
  {
    return mIncomingBandwidthUsageAvg;
  }
  /// Returns the maximum incoming bandwidth usage
  Kbps GetMaxIncomingBandwidthUsage() const
  {
    return mIncomingBandwidthUsageMax;
  }

  /// Returns the minimum total bandwidth usage (outgoing and incoming)
  Kbps GetMinTotalBandwidthUsage() const
  {
    return mTotalBandwidthUsageMin;
  }
  /// Returns the average total bandwidth usage (outgoing and incoming)
  Kbps GetAvgTotalBandwidthUsage() const
  {
    return mTotalBandwidthUsageAvg;
  }
  /// Returns the maximum total bandwidth usage (outgoing and incoming)
  Kbps GetMaxTotalBandwidthUsage() const
  {
    return mTotalBandwidthUsageMax;
  }

  /// Returns the minimum packet send rate
  uint GetMinSendRate() const
  {
    return mSendRateMin;
  }
  /// Returns the average packet send rate
  double GetAvgSendRate() const
  {
    return mSendRateAvg;
  }
  /// Returns the maximum packet send rate
  uint GetMaxSendRate() const
  {
    return mSendRateMax;
  }

  /// Returns the minimum packet receive rate
  uint GetMinReceiveRate() const
  {
    return mReceiveRateMin;
  }
  /// Returns the average packet receive rate
  double GetAvgReceiveRate() const
  {
    return mReceiveRateAvg;
  }
  /// Returns the maximum packet receive rate
  uint GetMaxReceiveRate() const
  {
    return mReceiveRateMax;
  }

  /// Returns the minimum sent packet byte size
  Bytes GetMinSentPacketBytes() const
  {
    return mSentPacketBytesMin;
  }
  /// Returns the average sent packet byte size
  double GetAvgSentPacketBytes() const
  {
    return mSentPacketBytesAvg;
  }
  /// Returns the maximum sent packet byte size
  Bytes GetMaxSentPacketBytes() const
  {
    return mSentPacketBytesMax;
  }

  /// Returns the minimum received packet byte size
  Bytes GetMinReceivedPacketBytes() const
  {
    return mReceivedPacketBytesMin;
  }
  /// Returns the average received packet byte size
  double GetAvgReceivedPacketBytes() const
  {
    return mReceivedPacketBytesAvg;
  }
  /// Returns the maximum received packet byte size
  Bytes GetMaxReceivedPacketBytes() const
  {
    return mReceivedPacketBytesMax;
  }

  /// Returns the total number of packets ever sent (unaffected by ResetStats)
  uintmax GetTotalPacketsSent() const
  {
    return mPacketsSent;
  }
