...
public:
  ...
  virtual bool NeedsBuilding(BuildOptions& options) { return false; }
  ...
  virtual String GetTag(){ return String(); }

  virtual String GetResourceOwner() { return String(); }
