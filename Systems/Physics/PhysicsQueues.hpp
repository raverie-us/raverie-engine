...
struct PhysicsQueue
{
  ...
  void ProcessQueue(BroadPhaseBatch& staticBatch, BroadPhaseBatch& dynamicBatch, void* colliderKey);
  void GetBroadPhaseData(void* colliderKey, BroadPhaseAction& action, BroadPhaseData& data);
