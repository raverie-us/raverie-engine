...
inline void ResolveSimpleFunction(RaverieSpirVFrontEnd* translator, Raverie::FunctionCallNode* functionCallNode, Raverie::MemberAccessNode* memberAccessNode, RaverieSpirVFrontEndContext* context)
{
...
template <OpType opType>
inline void ResolveUnaryOperator(RaverieSpirVFrontEnd* translator, Raverie::UnaryOperatorNode* unaryOpNode, RaverieSpirVFrontEndContext* context)
{
  ResolveUnaryOperator(translator, unaryOpNode, opType, context);
}

template <OpType opType>
inline void ResolveBinaryOperator(RaverieSpirVFrontEnd* translator, Raverie::BinaryOperatorNode* binaryOpNode, RaverieSpirVFrontEndContext* context)
{
