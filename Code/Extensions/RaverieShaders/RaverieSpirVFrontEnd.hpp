...
public:
  ...
  RaverieShaderIRType* MakeTypeInternal(RaverieShaderIRLibrary* shaderLibrary,
                                      ShaderIRTypeBaseType::Enum baseType,
                                      StringParam typeName,
                                      Raverie::BoundType* raverieType,
                                      spv::StorageClass storageClass);
  RaverieShaderIRType* MakeTypeAndPointer(RaverieShaderIRLibrary* shaderLibrary,
                                        ShaderIRTypeBaseType::Enum baseType,
                                        StringParam typeName,
                                        Raverie::BoundType* raverieType,
                                        spv::StorageClass pointerStorageClass);
  RaverieShaderIRType* MakeCoreType(RaverieShaderIRLibrary* shaderLibrary,
                                  ShaderIRTypeBaseType::Enum baseType,
                                  size_t components,
                                  RaverieShaderIRType* componentType,
                                  Raverie::BoundType* raverieType,
                                  bool makePointerType = true);
  RaverieShaderIRType* MakeStructType(RaverieShaderIRLibrary* shaderLibrary,
                                    StringParam typeName,
                                    Raverie::BoundType* raverieType,
                                    spv::StorageClass pointerStorageClass);
  RaverieShaderIRType* FindOrCreateInterfaceType(RaverieShaderIRLibrary* shaderLibrary,
  ...
  RaverieShaderIRType* FindOrCreateInterfaceType(RaverieShaderIRLibrary* shaderLibrary,
                                               ...
                                               ShaderIRTypeBaseType::Enum baseType,
                                               spv::StorageClass storageClass);
  RaverieShaderIRType* FindOrCreatePointerInterfaceType(RaverieShaderIRLibrary* shaderLibrary,
                                                      RaverieShaderIRType* valueType,
                                                      spv::StorageClass storageClass);
  ShaderIRTypeMeta* MakeShaderTypeMeta(RaverieShaderIRType* shaderType,
  ...
  void ParseAttributes(Raverie::Array<Raverie::Attribute>& raverieAttributes,
  ...
  void ParseRaverieAttributes(Raverie::Array<Raverie::Attribute>& raverieAttributes,
                            Raverie::NodeList<Raverie::AttributeNode>* attributeNodes,
                            ShaderIRAttributeList& shaderAttributes);
  // Loads a raverie attribute into an IR attribute. Uses the node's location if
  // available.
  void ParseRaverieAttribute(Raverie::Attribute& raverieAttribute,
  ...
  String BuildFunctionTypeString(Raverie::BoundType* raverieReturnType,
                                 Array<Raverie::Type*>& signature,
                                 RaverieSpirVFrontEndContext* context);
  void GenerateFunctionType(Raverie::SyntaxNode* locationNode,
  ...
  RaverieShaderIRFunction* GenerateIRFunction(Raverie::SyntaxNode* node,
                                            ...
                                            RaverieSpirVFrontEndContext* context);
  void AddImplements(Raverie::SyntaxNode* node,
                     Raverie::Function* raverieFunction,
  ...
  void AddRuntimeArray(Raverie::MemberVariableNode* node,
                       RaverieShaderIRType* varType,
                       ShaderIRFieldMeta* fieldMeta,
                       RaverieSpirVFrontEndContext* context);
  void AddGlobalVariable(Raverie::MemberVariableNode* node,
                         RaverieShaderIRType* varType,
                         ShaderIRFieldMeta* fieldMeta,
                         spv::StorageClass storageClass,
                         RaverieSpirVFrontEndContext* context);
  ...
  void DefaultConstructType(Raverie::SyntaxNode* locationNode,
  ...
  void GenerateEntryPoint(Raverie::GenericFunctionNode* node,
                          RaverieShaderIRFunction* function,
                          RaverieSpirVFrontEndContext* context);

  void WalkFunctionCallNode(Raverie::FunctionCallNode*& node, RaverieSpirVFrontEndContext* context);
  void WalkConstructorCallNode(Raverie::FunctionCallNode*& node,
                               Raverie::StaticTypeNode* constructorNode,
                               RaverieSpirVFrontEndContext* context);
  void WalkMemberAccessCallNode(Raverie::FunctionCallNode*& node,
                                Raverie::MemberAccessNode* memberAccessNode,
                                RaverieSpirVFrontEndContext* context);
  void WalkMemberAccessFunctionCallNode(Raverie::FunctionCallNode*& node,
                                        Raverie::MemberAccessNode* memberAccessNode,
                                        RaverieShaderIRFunction* shaderFunction,
                                        RaverieSpirVFrontEndContext* context);
  ...
  void WalkGenericLoop(Raverie::SyntaxNode* initializerNode,
  ...
  void GenerateLoopHeaderBlock(BasicBlock* headerBlock,
                               ...
                               RaverieSpirVFrontEndContext* context);
  void GenerateLoopConditionBlock(Raverie::ConditionalLoopNode* conditionalNode,
                                  BasicBlock* conditionBlock,
                                  BasicBlock* branchTrueBlock,
                                  BasicBlock* branchFalseBlock,
                                  RaverieSpirVFrontEndContext* context);
  void GenerateLoopStatements(Raverie::LoopScopeNode* loopScopeNode,
                              BasicBlock* loopBlock,
                              BasicBlock* mergeBlock,
                              BasicBlock* continueBlock,
                              RaverieSpirVFrontEndContext* context);
  void GenerateLoopContinueBlock(Raverie::SyntaxNode* iterator,
                                 BasicBlock* continueBlock,
  ...
  // expressions (e.g. +=).
  bool ResolveSetter(Raverie::BinaryOperatorNode* node,
  ...
  IRaverieShaderIR* PerformBinaryOp(Raverie::BinaryOperatorNode*& node,
                                  OpType opType,
  ...
  void PerformBinaryAssignmentOp(Raverie::BinaryOperatorNode*& node,
                                 OpType opType,
                                 IRaverieShaderIR* lhs,
                                 IRaverieShaderIR* rhs,
                                 RaverieSpirVFrontEndContext* context);
  ...
  IRaverieShaderIR* PerformUnaryIncDecOp(Raverie::UnaryOperatorNode*& node,
  ...
  RaverieShaderIROp* ConstructCompositeFromScalar(BasicBlock* block,
                                                RaverieShaderIRType* compositeType,
                                                IRaverieShaderIR* scalar,
                                                RaverieSpirVFrontEndContext* context);

  /// Create a specialization constant from a member variable node.
  RaverieShaderIROp* AddSpecializationConstant(Raverie::MemberVariableNode* node,
                                             RaverieShaderIRType* varType,
                                             RaverieSpirVFrontEndContext* context);
  ...
  /// valid for scalars).
  RaverieShaderIROp* AddSpecializationConstantRecursively(void* key,
                                                        RaverieShaderIRType* varType,
                                                        StringParam varName,
  ...
  RaverieShaderIROp* CreateSpecializationConstant(void* key,
                                                OpType opType,
                                                RaverieShaderIRType* varType,
                                                RaverieSpirVFrontEndContext* context);
  ...
  RaverieShaderIROp* BuildIROpNoBlockAdd(OpType opType,
                                       RaverieShaderIRType* resultType,
                                       RaverieSpirVFrontEndContext* context);
  RaverieShaderIROp*
  BuildIROp(BasicBlock* block, OpType opType, RaverieShaderIRType* resultType, RaverieSpirVFrontEndContext* context);
  RaverieShaderIROp* BuildIROp(BasicBlock* block,
                             OpType opType,
                             RaverieShaderIRType* resultType,
  ...
  RaverieShaderIROp* BuildIROp(BasicBlock* block,
                             ...
                             RaverieSpirVFrontEndContext* context);
  RaverieShaderIROp* BuildCurrentBlockIROp(OpType opType,
                                         RaverieShaderIRType* resultType,
                                         RaverieSpirVFrontEndContext* context);
  RaverieShaderIROp* BuildCurrentBlockIROp(OpType opType,
                                         RaverieShaderIRType* resultType,
  ...
  RaverieShaderIROp* BuildCurrentBlockIROp(OpType opType,
                                         ...
                                         IRaverieShaderIR* arg2,
                                         RaverieSpirVFrontEndContext* context);
  RaverieShaderIROp* BuildCurrentBlockAccessChain(RaverieShaderIRType* baseResultType,
  ...
  RaverieShaderIROp* BuildCurrentBlockAccessChain(RaverieShaderIRType* baseResultType,
                                                ...
                                                IRaverieShaderIR* arg1,
                                                RaverieSpirVFrontEndContext* context);
  RaverieShaderIROp* BuildDecorationOp(BasicBlock* block,
  ...
  RaverieShaderIROp* BuildDecorationOp(BasicBlock* block,
                                     ...
                                     int decorationValue,
                                     RaverieSpirVFrontEndContext* context);
  RaverieShaderIROp* BuildMemberDecorationOp(BasicBlock* block,
                                           IRaverieShaderIR* decorationTarget,
                                           int memberOffset,
                                           spv::Decoration decorationType,
                                           RaverieSpirVFrontEndContext* context);
  ...
  RaverieShaderIROp* BuildOpVariable(BasicBlock* block,
                                   RaverieShaderIRType* resultType,
                                   int storageConstant,
                                   RaverieSpirVFrontEndContext* context);
  IRaverieShaderIR* WalkAndGetResult(Raverie::SyntaxNode* node, RaverieSpirVFrontEndContext* context);
  RaverieShaderIROp* WalkAndGetValueTypeResult(BasicBlock* block,
  ...
  RaverieShaderIROp* GetOrGenerateValueTypeFromIR(BasicBlock* block,
  ...
  RaverieShaderIROp* GetOrGeneratePointerTypeFromIR(BasicBlock* block,
                                                  IRaverieShaderIR* instruction,
                                                  RaverieSpirVFrontEndContext* context);
  ...
  RaverieShaderIROp* BuildStoreOp(IRaverieShaderIR* target,
                                IRaverieShaderIR* source,
                                RaverieSpirVFrontEndContext* context,
                                bool forceLoadStore = true);
  RaverieShaderIROp* BuildStoreOp(BasicBlock* block,
                                IRaverieShaderIR* target,
                                IRaverieShaderIR* source,
                                RaverieSpirVFrontEndContext* context,
                                bool forceLoadStore = true);
  void GetFunctionCallArguments(Raverie::FunctionCallNode* node,
                                Raverie::MemberAccessNode* memberAccessNode,
  ...
  void GetFunctionCallArguments(Raverie::FunctionCallNode* node,
                                ...
                                Array<IRaverieShaderIR*>& arguments,
                                RaverieSpirVFrontEndContext* context);
  void WriteFunctionCallArguments(Array<IRaverieShaderIR*> arguments,
                                  RaverieShaderIRType* functionType,
                                  RaverieShaderIROp* functionCallOp,
                                  RaverieSpirVFrontEndContext* context);
  void WriteFunctionCallArgument(IRaverieShaderIR* argument,
                                 RaverieShaderIROp* functionCallOp,
  ...
  void WriteFunctionCall(Array<IRaverieShaderIR*> arguments,
                         RaverieShaderIRFunction* shaderFunction,
                         RaverieSpirVFrontEndContext* context);

  // Helpers
  RaverieShaderIROp* GenerateBoolToIntegerCast(BasicBlock* block,
                                             RaverieShaderIROp* source,
                                             RaverieShaderIRType* destType,
                                             RaverieSpirVFrontEndContext* context);
  RaverieShaderIROp* GenerateFromBoolCast(BasicBlock* block,
                                        RaverieShaderIROp* source,
                                        RaverieShaderIRType* destType,
                                        IRaverieShaderIR* zero,
                                        IRaverieShaderIR* one,
                                        RaverieSpirVFrontEndContext* context);
  RaverieShaderIROp* GenerateIntegerToBoolCast(BasicBlock* block,
                                             RaverieShaderIROp* source,
                                             RaverieShaderIRType* destType,
                                             RaverieSpirVFrontEndContext* context);
  RaverieShaderIROp* GenerateToBoolCast(BasicBlock* block,
                                      OpType op,
                                      RaverieShaderIROp* source,
                                      RaverieShaderIRType* destType,
                                      IRaverieShaderIR* zero,
  ...
  bool CheckForNonCopyableType(RaverieShaderIRType* shaderType,
  ...
  bool ValidateResultType(IRaverieShaderIR* instruction,
