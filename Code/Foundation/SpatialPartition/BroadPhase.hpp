...
public:
  ...
  {
    mCastRayCallBack = callback;
  }
  static void SetCastSegmentCallBack(RayCastCallBack callback)
  {
    mCastSegmentCallBack = callback;
  }
  static void SetCastAabbCallBack(VolumeCastCallBack callback)
  {
    mCastAabbCallBack = callback;
  }
  static void SetCastSphereCallBack(VolumeCastCallBack callback)
  {
    mCastSphereCallBack = callback;
  }
  static void SetCastFrustumCallBack(VolumeCastCallBack callback)
  {
    mCastFrustumCallBack = callback;
  }
