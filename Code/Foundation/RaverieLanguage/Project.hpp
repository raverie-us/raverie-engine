...
// parsed Raverie code may depend upon
RaverieDeclareEvent(PreParser, ParseEvent);
...
RaverieDeclareEvent(TypeParsed, ParseEvent);
...
// able to be used by the Raverie scripts Note: None of the code from the library
// should be executed at this time
RaverieDeclareEvent(PostSyntaxer, ParseEvent);
} // namespace Events
...
{
public:
  RaverieDeclareType(ParseEvent, TypeCopyMode::ReferenceType);
...
// order is actually important to Raverie
