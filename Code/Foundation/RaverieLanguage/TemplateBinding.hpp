...
#  define RaverieFullBindMethod(                                                                                         \
      RaverieBuilder, RaverieType, MethodPointer, OverloadResolution, Name, SpaceDelimitedParameterNames)                  \
    ::Raverie::TemplateBinding::FromMethod<decltype(OverloadResolution MethodPointer), MethodPointer>(                        \
        RaverieBuilder, RaverieType, Name, SpaceDelimitedParameterNames, OverloadResolution(MethodPointer))
...
#  define RaverieFullBindVirtualMethod(RaverieBuilder, RaverieType, MethodPointer, NameOrNull)                               \
    ::Raverie::TemplateBinding::FromVirtual<decltype(MethodPointer), MethodPointer>(                                          \
        RaverieBuilder, RaverieType, Name, SpaceDelimitedParameterNames, (MethodPointer))
...
#  define RaverieFullBindConstructorVirtual(RaverieBuilder, RaverieType, Class, SpaceDelimitedParameterNames, ...)           \
    ::Raverie::TemplateBinding::FromConstructorVirtual<Class, ##__VA_ARGS__>(                                                 \
        RaverieBuilder, RaverieType, SpaceDelimitedParameterNames)

// Bind the destructor of a class
// The destructor should ALWAYS be bound if the constructor is bound
#  define RaverieFullBindDestructor(RaverieBuilder, RaverieType, Class)                                                      \
    ::Raverie::TemplateBinding::FromDestructor<Class>(RaverieBuilder, RaverieType)

// Bind data members as properties
#  define RaverieFullBindField(RaverieBuilder, RaverieType, FieldPointer, Name, PropertyBinding)                             \
    ::Raverie::TemplateBinding::FromField<decltype(FieldPointer), FieldPointer>(                                              \
        RaverieBuilder, RaverieType, Name, FieldPointer, PropertyBinding)
...
#  define RaverieFullBindMember(RaverieBuilder, RaverieType, MemberName, Name, PropertyBinding)                              \
    [&]() {                                                                                                            \
      ErrorIf(RaverieTypeId(decltype(RaverieSelf::MemberName))->GetCopyableSize() != sizeof(RaverieSelf::MemberName),        \
              ...
              "RaverieBindField.");                                                                                      \
      return RaverieBuilder.AddBoundField(RaverieType,                                                                     \
                                        Name,                                                                          \
                                        RaverieTypeId(decltype(RaverieSelf::MemberName)),                                  \
                                        RaverieOffsetOf(RaverieSelf, MemberName),                                           \
                                        PropertyBinding);                                                              \
    }()
...
#  define RaverieFullBindGetterSetter(                                                                                   \
      RaverieBuilder, RaverieType, GetterMethodPointer, GetterOverload, SetterMethodPointer, SetterOverload, Name)         \
    ::Raverie::TemplateBinding::FromGetterSetter<decltype(GetterOverload GetterMethodPointer),                                \
                                          GetterMethodPointer,                                                         \
...
#  define RaverieFullBindEnum(RaverieBuilder, RaverieType, SpecialTypeEnum)                                                  \
    ...
    {                                                                                                                  \
      ...
      ErrorIf((RaverieType)->Size != sizeof(::Raverie::Integer),                                                                \
              "The sizeof(Enum) bound to Raverie must match the sizeof(Integer)");                                       \
      (RaverieType)->BaseType = RaverieTypeId(::Raverie::Enum);                                                                   \
    } while (false)

// Bind a single value of
#  define RaverieFullBindEnumValue(RaverieBuilder, RaverieType, EnumValue, Name)                                             \
    (RaverieBuilder).AddEnumValue((RaverieType), (Name), (EnumValue));
...
// the name
#  define RaverieBindOverloadedMethodAs(MethodName, OverloadResolution, Name)                                            \
    RaverieFullBindMethod(builder, type, &RaverieSelf::MethodName, OverloadResolution, Name, RaverieNoNames)
...
#  define RaverieBindOverloadedMethodPropertyAs(MethodName, OverloadResolution, Name)                                    \
    RaverieFullBindMethod(builder, type, &RaverieSelf::MethodName, OverloadResolution, Name, RaverieNoNames)                 \
        ->AddAttributeChainable(Raverie::PropertyAttribute)
#  define RaverieBindMethodPropertyAs(MethodName, Name)                                                                  \
    RaverieBindOverloadedMethodAs(MethodName, RaverieNoOverload, Name)->AddAttributeChainable(Raverie::PropertyAttribute)
#  define RaverieBindMemberAs(MemberName, Name)                                                                          \
    RaverieFullBindMember(builder, type, MemberName, Name, Raverie::MemberOptions::None)
#  define RaverieBindMemberPropertyAs(MemberName, Name)                                                                  \
    RaverieBindMemberAs(MemberName, Name)->AddAttributeChainable(Raverie::PropertyAttribute)
#  define RaverieBindFieldAs(FieldName, Name)                                                                            \
    RaverieFullBindField(builder, type, &RaverieSelf::FieldName, Name, Raverie::PropertyBinding::GetSet)
#  define RaverieBindFieldGetterAs(FieldName, Name)                                                                      \
    RaverieFullBindField(builder, type, &RaverieSelf::FieldName, Name, Raverie::PropertyBinding::Get)
#  define RaverieBindFieldSetterAs(FieldName, Name)                                                                      \
    RaverieFullBindField(builder, type, &RaverieSelf::FieldName, Name, Raverie::PropertyBinding::Set)
#  define RaverieBindFieldPropertyAs(FieldName, Name)                                                                    \
    RaverieBindFieldAs(FieldName, Name)->AddAttributeChainable(Raverie::PropertyAttribute)
#  define RaverieBindFieldGetterPropertyAs(FieldName, Name)                                                              \
    RaverieBindFieldGetterAs(FieldName, Name)->AddAttributeChainable(Raverie::PropertyAttribute)
#  define RaverieBindFieldSetterPropertyAs(FieldName, Name)                                                              \
    RaverieBindFieldSetterAs(FieldName, Name)->AddAttributeChainable(Raverie::PropertyAttribute)
#  define RaverieBindGetterAs(PropertyName, Name)                                                                        \
    RaverieFullBindGetterSetter(                                                                                         \
        builder, type, &RaverieSelf::Get##PropertyName, RaverieNoOverload, RaverieNoSetter, RaverieNoOverload, Name)
#  define RaverieBindSetterAs(PropertyName, Name)                                                                        \
    RaverieFullBindGetterSetter(                                                                                         \
        builder, type, RaverieNoGetter, RaverieNoOverload, &RaverieSelf::Set##PropertyName, RaverieNoOverload, Name)
#  define RaverieBindGetterSetterAs(PropertyName, Name)                                                                  \
    RaverieFullBindGetterSetter(builder,                                                                                 \
                              type,                                                                                    \
                              &RaverieSelf::Get##PropertyName,                                                           \
                              RaverieNoOverload,                                                                         \
                              &RaverieSelf::Set##PropertyName,                                                           \
                              RaverieNoOverload,                                                                         \
                              Name)
#  define RaverieBindGetterPropertyAs(PropertyName, Name)                                                                \
    RaverieBindGetterAs(PropertyName, Name)->AddAttributeChainable(Raverie::PropertyAttribute)
#  define RaverieBindSetterPropertyAs(PropertyName, Name)                                                                \
    RaverieBindSetterAs(PropertyName, Name)->AddAttributeChainable(Raverie::PropertyAttribute)
#  define RaverieBindGetterSetterPropertyAs(PropertyName, Name)                                                          \
    RaverieBindGetterSetterAs(PropertyName, Name)->AddAttributeChainable(Raverie::PropertyAttribute)
#  define RaverieBindCustomGetterAs(PropertyName, Name)                                                                  \
    RaverieFullBindGetterSetter(                                                                                         \
        builder, type, &RaverieSelf::PropertyName, RaverieNoOverload, RaverieNoSetter, RaverieNoOverload, Name)
#  define RaverieBindCustomSetterAs(PropertyName, Name)                                                                  \
    RaverieFullBindGetterSetter(                                                                                         \
        builder, type, RaverieNoGetter, RaverieNoOverload, &RaverieSelf::PropertyName, RaverieNoOverload, Name)
#  define RaverieBindCustomGetterSetterAs(PropertyName, Name)                                                            \
    RaverieFullBindGetterSetter(                                                                                         \
        builder, type, &RaverieSelf::PropertyName, RaverieNoOverload, &RaverieSelf::PropertyName, RaverieNoOverload, Name)
#  define RaverieBindCustomGetterPropertyAs(PropertyName, Name)                                                          \
    RaverieBindCustomGetterAs(PropertyName, Name)->AddAttributeChainable(Raverie::PropertyAttribute)
#  define RaverieBindCustomSetterPropertyAs(PropertyName, Name)                                                          \
    RaverieBindCustomSetterAs(PropertyName, Name)->AddAttributeChainable(Raverie::PropertyAttribute)
#  define RaverieBindCustomGetterSetterPropertyAs(PropertyName, Name)                                                    \
    RaverieBindCustomGetterSetterAs(PropertyName, Name)->AddAttributeChainable(Raverie::PropertyAttribute)
...
// identifier
#  define RaverieBindOverloadedMethod(MethodName, OverloadResolution)                                                    \
    RaverieBindOverloadedMethodAs(MethodName, OverloadResolution, #MethodName)
#  define RaverieBindMethod(MethodName) RaverieBindMethodAs(MethodName, #  MethodName)
#  define RaverieBindOverloadedMethodProperty(MethodName, OverloadResolution)                                            \
    RaverieBindOverloadedPropertyMethodAs(MethodName, OverloadResolution, #MethodName)
...
#  define RaverieBindCustomGetterSetterProperty(PropertyName)                                                            \
    RaverieBindCustomGetterSetterPropertyAs(PropertyName, #PropertyName)
