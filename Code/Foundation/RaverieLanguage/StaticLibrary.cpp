...
{
  RaverieErrorIfNotStarted(StaticLibrary);
...
void StaticLibrary::BuildLibrary()
{
  ...
  // This is generally used to provide clear error messages in RaverieTypeId
  this->Build = BuildState::Building;

  // Build all dependent libraries
  RaverieForEach (StaticLibrary* dependency, this->Dependencies)
  {
  ...
  // Make sure the user properly initialized all types that we did RaverieTypeId
  // for
