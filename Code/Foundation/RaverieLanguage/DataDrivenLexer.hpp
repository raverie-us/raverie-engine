...
{
using Raverie::C;
using Raverie::CaptureExpressionNode;
using Raverie::Character;
using Raverie::GrammarNode;
using Raverie::GrammarRule;
using Raverie::GrammarSet;
using Raverie::P;
using Raverie::ParseNodeInfo;
using Raverie::ParseTreeBuilder;
using Raverie::R;
using Raverie::RecursiveDescentParser;
using Raverie::ReplacementNode;
using Raverie::T;
using Raverie::Token;
using Raverie::TokenRange;
using Raverie::TokenStream;
...
public:
  ...
  friend class Raverie::RecursiveDescentParser;
