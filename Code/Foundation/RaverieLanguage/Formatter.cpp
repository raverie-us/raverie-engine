...
RaverieCodeBuilder::RaverieCodeBuilder() : Indentation(0), Line(1), Character(1)
{
}

void RaverieCodeBuilder::WriteKeywordOrSymbol(Grammar::Enum token)
{
...
void RaverieCodeBuilder::BeginScope(ScopeType::Enum scope)
{
...
void RaverieCodeBuilder::EndScope()
{
...
void RaverieCodeBuilder::WriteLine()
{
...
void RaverieCodeBuilder::WriteLineIndented()
{
  // Create a new line
  this->WriteLine();
...
void RaverieCodeBuilder::Write(const UserToken& token)
{
  this->Write(token.Token);
}

void RaverieCodeBuilder::WriteLineStyle(LineStyle::Enum specific, LineStyle::Enum globalDefault)
{
...
void RaverieCodeBuilder::WriteIndent()
{
...
void RaverieCodeBuilder::WriteSpace()
{
  this->Write(" ");
}

void RaverieCodeBuilder::WriteSingleLineComment(StringParam text)
{
  this->Write("//");
...
void RaverieCodeBuilder::TrimEnd()
{
...
String RaverieCodeBuilder::ToString()
{
  // HACK need to run post pass to trim trailing space / empty lines
  return StringBuilderExtended::ToString();
}

size_t RaverieCodeBuilder::GetLine()
{
  return this->Line;
}

RaverieCodeBuilder::ScopeStyle::ScopeStyle() : BracesIndented(false), InnardsIndented(false)
{
}
...
void CodeFormatter::FormatAttributes(NodeList<AttributeNode>& attributes, RaverieCodeBuilder& builder)
{
...
void FormatFunctionPostArgs(FunctionNode* node, RaverieCodeBuilder& builder)
{
...
void FormatConstructorPostArgs(ConstructorNode* node, RaverieCodeBuilder& builder)
{
}
...
void FormatDestructorPostArgs(DestructorNode* node, RaverieCodeBuilder& builder)
{
}
