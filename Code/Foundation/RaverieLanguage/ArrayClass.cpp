...
// For all other unknown types (such as structs created in Raverie) we use the
// 'Any' type
template <typename T>
...
public:
  ...
  static void ArrayRemoveAll(Call& call, ExceptionReport& report)
  {
    ...
    size_t removeCount = RemoveAll(self->NativeArray, Raverie::EqualTo<T>(testValue));
  ...
  public:
    ...
    bool operator()(T& left, T& right)
    {
      ...
      Raverie::Call call(*this->Comparer, this->State);
...
public:
  // Constructor
  ArrayRangeTemplate() : Current(0), Start(0), Count(0), ModifyId(0)
  {
  }
