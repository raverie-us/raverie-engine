...
void Sha1Builder::RunUnitTests()
{
  ...
  const char* outputs[] = {
      "A9993E364706816ABA3E25717850C26C9CD0D89D", "84983E441C3BD26EBAAE4AA1F95129E5E54670F1", "34AA973CD4C4DAA4F61EEB2BDBAD27316534016F", "EB3F49B034A2804826A742754868665D8BCBF4EF"};
...
String Sha1Builder::OutputHashString()
{
  ...
  {
    RaverieSPrintf(hexedSha1 + 2 * i, 3, "%02X", hash[i]);
  }
...
String Sha1Builder::GetHashStringFromFile(Status& status, StringParam fileName)
{
  ...
  File file;
  file.Open(fileName, Raverie::FileMode::Read, Raverie::FileAccessPattern::Sequential, Raverie::FileShare::Read, &status);
  if (status.Failed())
    return String();
