...
void ScriptTokenizer::Finalize(Array<UserToken>& tokensOut)
{
...
bool ScriptTokenizer::ParseInternal(Array<UserToken>& tokensOut, Array<UserToken>& commentsOut)
{
...
char ScriptTokenizer::ReadCharacter()
{
...
bool ScriptTokenizer::DiffString(const char* string)
{
...
bool ScriptTokenizer::ReadIdentifier(UserToken* outToken, bool startedFromKeyword, size_t& lastAcceptedPos, char& character)
{
...
bool ScriptTokenizer::ReadNumber(UserToken* outToken, size_t& lastAcceptedPos, char& character)
{
  // Whether or not we've accepted the token
  bool acceptedToken = false;
...
bool ScriptTokenizer::ReadString(UserToken* outToken, size_t& lastAcceptedPos, char& character)
{
...
bool ScriptTokenizer::ReadToken(UserToken* outToken)
{
...
void ScriptTokenizer::UpdateLineAndCharacterNumber(char character)
{
...
String ScriptTokenizer::SkipToEndOfLine()
{
