...
namespace Events
{
RaverieDefineEvent(ConsoleWrite);
RaverieDefineEvent(ConsoleRead);
} // namespace Events

// Initialize static variables
EventHandler ScriptConsole::Events;
static String ConsoleSeparator(", ");
static String NewLine("\n");

RaverieDefineType(ConsoleEvent, builder, type)
{
}
...
RaverieDefineType(ScriptConsole, builder, type)
{
  ...
  RaverieFullBindMethod(builder, type, &ScriptConsole::ReadString, RaverieNoOverload, "ReadString", nullptr);
  RaverieFullBindMethod(builder, type, &ScriptConsole::ReadInteger, RaverieNoOverload, "ReadInteger", nullptr);
  RaverieFullBindMethod(builder, type, &ScriptConsole::ReadBoolean, RaverieNoOverload, "ReadBoolean", nullptr);
  RaverieFullBindMethod(builder, type, &ScriptConsole::ReadReal, RaverieNoOverload, "ReadReal", nullptr);
}

void ScriptConsole::WriteData(StringParam text)
{
...
void ScriptConsole::Write(AnyParam value0)
{
  WriteData(value0.ToString());
}

void ScriptConsole::Write(AnyParam value0, AnyParam value1)
{
  WriteData(BuildString(value0.ToString(), ConsoleSeparator, value1.ToString()));
}

void ScriptConsole::Write(AnyParam value0, AnyParam value1, AnyParam value2)
{
  WriteData(BuildString(value0.ToString(), ConsoleSeparator, value1.ToString(), ConsoleSeparator, value2.ToString()));
}

void ScriptConsole::Write(AnyParam value0, AnyParam value1, AnyParam value2, AnyParam value3)
{
...
void ScriptConsole::Write(AnyParam value0, AnyParam value1, AnyParam value2, AnyParam value3, AnyParam value4)
{
  StringBuilder builder;
  builder.Append(value0.ToString());
  builder.Append(ConsoleSeparator);
...
void ScriptConsole::Write(StringParam value)
{
  WriteData(value);
}

void ScriptConsole::Write(StringRange value)
{
  WriteData(value);
}

void ScriptConsole::Write(cstr value)
{
  WriteData(String(value));
}

void ScriptConsole::Write(char value)
{
  WriteData(String(value));
}

void ScriptConsole::Write(Integer value)
{
  WriteData(IntegerToString(value));
}

void ScriptConsole::Write(Integer2Param value)
{
  WriteData(Integer2ToString(value));
}

void ScriptConsole::Write(Integer3Param value)
{
  WriteData(Integer3ToString(value));
}

void ScriptConsole::Write(Integer4Param value)
{
  WriteData(Integer4ToString(value));
}

void ScriptConsole::Write(DoubleInteger value)
{
  WriteData(DoubleIntegerToString(value));
}

void ScriptConsole::Write(Boolean value)
{
  WriteData(BooleanToString(value));
}

void ScriptConsole::Write(Boolean2Param value)
{
  WriteData(Boolean2ToString(value));
}

void ScriptConsole::Write(Boolean3Param value)
{
  WriteData(Boolean3ToString(value));
}

void ScriptConsole::Write(Boolean4Param value)
{
  WriteData(Boolean4ToString(value));
}

void ScriptConsole::Write(Real value)
{
  WriteData(RealToString(value));
}

void ScriptConsole::Write(DoubleReal value)
{
  WriteData(DoubleRealToString(value));
}

void ScriptConsole::Write(Real2Param value)
{
  WriteData(Real2ToString(value));
}

void ScriptConsole::Write(Real3Param value)
{
  WriteData(Real3ToString(value));
}

void ScriptConsole::Write(Real4Param value)
{
  WriteData(Real4ToString(value));
}

void ScriptConsole::Write(QuaternionParam value)
{
  WriteData(QuaternionToString(value));
}

void ScriptConsole::WriteLine()
{
  WriteData(NewLine);
}

void ScriptConsole::WriteLine(AnyParam value0)
{
  WriteData(BuildString(value0.ToString(), NewLine));
}

void ScriptConsole::WriteLine(AnyParam value0, AnyParam value1)
{
  WriteData(BuildString(value0.ToString(), ConsoleSeparator, value1.ToString(), NewLine));
}

void ScriptConsole::WriteLine(AnyParam value0, AnyParam value1, AnyParam value2)
{
  StringBuilder builder;
  builder.Append(value0.ToString());
  builder.Append(ConsoleSeparator);
...
void ScriptConsole::WriteLine(AnyParam value0, AnyParam value1, AnyParam value2, AnyParam value3)
{
  StringBuilder builder;
  builder.Append(value0.ToString());
  builder.Append(ConsoleSeparator);
...
void ScriptConsole::WriteLine(AnyParam value0, AnyParam value1, AnyParam value2, AnyParam value3, AnyParam value4)
{
  StringBuilder builder;
  builder.Append(value0.ToString());
  builder.Append(ConsoleSeparator);
...
void ScriptConsole::WriteLine(StringParam value)
{
  WriteData(BuildString(value, NewLine));
}

void ScriptConsole::WriteLine(StringRange value)
{
  WriteData(BuildString(value, NewLine));
}

void ScriptConsole::WriteLine(cstr value)
{
  WriteData(BuildString(String(value), NewLine));
}

void ScriptConsole::WriteLine(char value)
{
  WriteData(BuildString(String(value), NewLine));
}

void ScriptConsole::WriteLine(Integer value)
{
  WriteData(BuildString(IntegerToString(value), NewLine));
}

void ScriptConsole::WriteLine(Integer2Param value)
{
  WriteData(BuildString(Integer2ToString(value), NewLine));
}

void ScriptConsole::WriteLine(Integer3Param value)
{
  WriteData(BuildString(Integer3ToString(value), NewLine));
}

void ScriptConsole::WriteLine(Integer4Param value)
{
  WriteData(BuildString(Integer4ToString(value), NewLine));
}

void ScriptConsole::WriteLine(DoubleInteger value)
{
  WriteData(BuildString(DoubleIntegerToString(value), NewLine));
}

void ScriptConsole::WriteLine(Boolean value)
{
  WriteData(BuildString(BooleanToString(value), NewLine));
}

void ScriptConsole::WriteLine(Boolean2Param value)
{
  WriteData(BuildString(Boolean2ToString(value), NewLine));
}

void ScriptConsole::WriteLine(Boolean3Param value)
{
  WriteData(BuildString(Boolean3ToString(value), NewLine));
}

void ScriptConsole::WriteLine(Boolean4Param value)
{
  WriteData(BuildString(Boolean4ToString(value), NewLine));
}

void ScriptConsole::WriteLine(Real value)
{
  WriteData(BuildString(RealToString(value), NewLine));
}

void ScriptConsole::WriteLine(DoubleReal value)
{
  WriteData(BuildString(DoubleRealToString(value), NewLine));
}

void ScriptConsole::WriteLine(Real2Param value)
{
  WriteData(BuildString(Real2ToString(value), NewLine));
}

void ScriptConsole::WriteLine(Real3Param value)
{
  WriteData(BuildString(Real3ToString(value), NewLine));
}

void ScriptConsole::WriteLine(Real4Param value)
{
  WriteData(BuildString(Real4ToString(value), NewLine));
}

void ScriptConsole::WriteLine(QuaternionParam value)
{
...
void ScriptConsole::DumpValue(AnyParam value)
{
  DumpValue(value, 1);
}

void ScriptConsole::DumpValue(AnyParam value, Integer howDeep)
{
...
String ScriptConsole::ReadString()
{
  // Just read the string directly (no interpreting, may be empty)
  return ReadData();
}

Integer ScriptConsole::ReadInteger()
{
...
Boolean ScriptConsole::ReadBoolean()
{
  // Just read the string directly (may be empty)
  String readText = ReadData();
