...
JsonReader::ReadIntoTreeFromString(CompilationErrors& errors, StringParam json, StringParam origin, void* userData)
{
  ...
  ScriptTokenizer tokenizer(errors);
  ...
  for (size_t i = 0; i < tokens.Size(); ++i)
  {
    ...
    case Grammar::IntegerLiteral:
    {
      ...
      Raverie::ToValue(token.Token, createdValue->IntegralValue);
    ...
    case Grammar::RealLiteral:
    {
      ...
      Raverie::ToValue(token.Token, createdValue->RealValue);
