...
namespace Raverie
{
StubCode::StubCode() : SetNativeLocations(false)
{
}
...
String StubCode::Finalize()
{
  ...
  RaverieForEach (CodeLocation* location, this->NativeLocations)
...
{
  RaverieCodeBuilder& codeBuilder = this->Builder;
  ...
  RaverieForEach (SendsEvent* sendsEvent, sendsEventsSorted)
  {
  ...
  RaverieForEach (Property* property, allPropertiesSorted)
  {
...
void StubCode::Generate(FunctionArray& functions)
{
  ...
  RaverieForEach (Function* function, functionsSorted)
  {
...
void StubCode::GenerateHeader(ReflectionObject* object, Array<Attribute>& attributes)
{
  ...
  String wrappedDescription = Raverie::WordWrap(object->Description, format.CommentWordWrapLength);
  RaverieForEach (StringRange line, wrappedDescription.Split("\n"))
  {
