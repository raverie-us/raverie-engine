...
public:
  ...
  {
    RegisterInternal((MemberFn)visitor, RaverieTypeId(ChildType), false);
  }
  ...
  {
    RegisterInternal((MemberFn)visitor, RaverieTypeId(DerivedChildType), false);
  }
  ...
  {
    RegisterInternal((MemberFn)visitor, RaverieTypeId(ChildType), true);
  }
