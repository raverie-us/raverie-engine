...
// The default values used here reflect the official coding standard of Raverie
class CodeFormat
{
public:
  // Constructor
...
// This class can be used to directly emit Raverie code as text
// It's mostly a convenience (handles scoping, formatting, spaces, keywords,
// etc)
class RaverieCodeBuilder : public StringBuilderExtended
{
public:
  // Constructor
  RaverieCodeBuilder();
...
// This is incredibly useful for auto-formatting Raverie code, or translating into
// other languages
class CodeFormatter
{
public:
...
private:
  ...
  // Format a class back into Raverie format
  void FormatAttributes(NodeList<AttributeNode>& attributes, RaverieCodeBuilder& builder);
