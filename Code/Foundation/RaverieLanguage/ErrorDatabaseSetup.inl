...
{
  ErrorInfo& error = this->Errors.PushBack();
  error.Error = "The type '%s' can only be created outside of Raverie.";
...
{
  ErrorInfo& error = this->Errors.PushBack();
  error.Error = "The type '%s' can only be deleted outside of Raverie.";
...
// ParameterTypeNotFound
{
  ...
  error.Reason = "Parameter names must have types associated with them. "
                 "Ambiguously-typed parameters are not allowed in Raverie.";
...
// ParameterTypeSpecifierNotFound
{
  ...
  error.Reason = "Function parameters must have types associated with them, "
                 "denoted by the syntax 'parameter : parameterType'. Raverie "
