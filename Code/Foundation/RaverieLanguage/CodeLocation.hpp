...
namespace Raverie
{
// We can print Raverie messages in many different formats
...
enum Enum
{
  // This is the standard format we use to print Raverie error messages
  ...
  // Msvc errors are useful when editing Raverie inside of Visual Studio,
...
public:
  ...
  // uses StartPosition/EndPosition)
...
// UserToken!
template <>
struct MoveWithoutDestructionOperator<Raverie::CodeLocation>
{
  static inline void MoveWithoutDestruction(Raverie::CodeLocation* dest, Raverie::CodeLocation* source)
  {
