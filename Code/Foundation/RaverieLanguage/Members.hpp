...
public:
  ...
  // The value will be represented as if it were a Raverie token (quotes will be
...
public:
  ...
  AttributeParameter(StringParam name, Raverie::Type* value);
...
{
public:
  RaverieDeclareType(ReflectionObject, TypeCopyMode::ReferenceType);
...
{
public:
  RaverieDeclareType(Member, TypeCopyMode::ReferenceType);
...
{
public:
  RaverieDeclareType(Property, TypeCopyMode::ReferenceType);
...
{
public:
  RaverieDeclareType(GetterSetter, TypeCopyMode::ReferenceType);
};
...
{
public:
  RaverieDeclareType(Field, TypeCopyMode::ReferenceType);
...
{
public:
  RaverieDeclareType(Variable, TypeCopyMode::ReferenceType);
