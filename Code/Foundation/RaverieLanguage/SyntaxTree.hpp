...
namespace Raverie
{
RaverieDeclareStaticLibrary(Syntax);
...
{
public:
  RaverieDeclareType(SyntaxNode, TypeCopyMode::ReferenceType);
...
{
public:
  RaverieDeclareType(SyntaxType, TypeCopyMode::ReferenceType);
...
{
public:
  RaverieDeclareType(AnySyntaxType, TypeCopyMode::ReferenceType);
  RaverieClonableNode(AnySyntaxType);
...
{
public:
  RaverieDeclareType(IndirectionSyntaxType, TypeCopyMode::ReferenceType);
  RaverieClonableNode(IndirectionSyntaxType);
...
{
public:
  RaverieDeclareType(BoundSyntaxType, TypeCopyMode::ReferenceType);
  RaverieClonableNode(BoundSyntaxType);
...
{
public:
  RaverieDeclareType(DelegateSyntaxType, TypeCopyMode::ReferenceType);
  RaverieClonableNode(DelegateSyntaxType);
...
{
public:
  RaverieDeclareType(RootNode, TypeCopyMode::ReferenceType);
  RaverieClonableNode(RootNode);
...
{
public:
  RaverieDeclareType(AttributeNode, TypeCopyMode::ReferenceType);
  RaverieClonableNode(AttributeNode);
...
{
public:
  RaverieDeclareType(StatementNode, TypeCopyMode::ReferenceType);
...
{
public:
  RaverieDeclareType(ExpressionNode, TypeCopyMode::ReferenceType);
...
{
public:
  RaverieDeclareType(BinaryOperatorNode, TypeCopyMode::ReferenceType);
  RaverieClonableNode(BinaryOperatorNode);
...
{
public:
  RaverieDeclareType(UnaryOperatorNode, TypeCopyMode::ReferenceType);
  RaverieClonableNode(UnaryOperatorNode);
...
{
public:
  RaverieDeclareType(PropertyDelegateOperatorNode, TypeCopyMode::ReferenceType);
  RaverieClonableNode(PropertyDelegateOperatorNode);
...
{
public:
  RaverieDeclareType(TypeCastNode, TypeCopyMode::ReferenceType);
  RaverieClonableNode(TypeCastNode);
...
{
public:
  RaverieDeclareType(PostExpressionNode, TypeCopyMode::ReferenceType);
...
{
public:
  RaverieDeclareType(IndexerCallNode, TypeCopyMode::ReferenceType);
  RaverieClonableNode(IndexerCallNode);
...
{
public:
  RaverieDeclareType(FunctionCallNode, TypeCopyMode::ReferenceType);
  RaverieClonableNode(FunctionCallNode);
...
{
public:
  RaverieDeclareType(MemberAccessNode, TypeCopyMode::ReferenceType);
  RaverieClonableNode(MemberAccessNode);
...
{
public:
  RaverieDeclareType(TypeIdNode, TypeCopyMode::ReferenceType);
  RaverieClonableNode(TypeIdNode);
...
{
public:
  RaverieDeclareType(MemberIdNode, TypeCopyMode::ReferenceType);
  RaverieClonableNode(MemberIdNode);
...
{
public:
  RaverieDeclareType(StaticTypeNode, TypeCopyMode::ReferenceType);
  RaverieClonableNode(StaticTypeNode);
...
{
public:
  RaverieDeclareType(ExpressionInitializerMemberNode, TypeCopyMode::ReferenceType);
  RaverieClonableNode(ExpressionInitializerMemberNode);
...
{
public:
  RaverieDeclareType(ExpressionInitializerAddNode, TypeCopyMode::ReferenceType);
  RaverieClonableNode(ExpressionInitializerAddNode);
...
{
public:
  RaverieDeclareType(ExpressionInitializerNode, TypeCopyMode::ReferenceType);
  RaverieClonableNode(ExpressionInitializerNode);
...
{
public:
  RaverieDeclareType(MultiExpressionNode, TypeCopyMode::ReferenceType);
  RaverieClonableNode(MultiExpressionNode);
...
{
public:
  RaverieDeclareType(VariableNode, TypeCopyMode::ReferenceType);
...
{
public:
  RaverieDeclareType(LocalVariableNode, TypeCopyMode::ReferenceType);
  RaverieClonableNode(LocalVariableNode);
...
{
public:
  RaverieDeclareType(ParameterNode, TypeCopyMode::ReferenceType);
  RaverieClonableNode(ParameterNode);
...
{
public:
  RaverieDeclareType(MemberVariableNode, TypeCopyMode::ReferenceType);
  RaverieClonableNode(MemberVariableNode);
...
{
public:
  RaverieDeclareType(ValueNode, TypeCopyMode::ReferenceType);
  RaverieClonableNode(ValueNode);
...
{
public:
  RaverieDeclareType(StringInterpolantNode, TypeCopyMode::ReferenceType);
  RaverieClonableNode(StringInterpolantNode);
...
{
public:
  RaverieDeclareType(DeleteNode, TypeCopyMode::ReferenceType);
  RaverieClonableNode(DeleteNode);
...
{
public:
  RaverieDeclareType(ReturnNode, TypeCopyMode::ReferenceType);
  RaverieClonableNode(ReturnNode);
...
{
public:
  RaverieDeclareType(ScopeNode, TypeCopyMode::ReferenceType);
  RaverieClonableNode(ScopeNode);
...
{
public:
  RaverieDeclareType(TimeoutNode, TypeCopyMode::ReferenceType);
  RaverieClonableNode(TimeoutNode);
...
{
public:
  RaverieDeclareType(IfNode, TypeCopyMode::ReferenceType);
  RaverieClonableNode(IfNode);
...
{
public:
  RaverieDeclareType(IfRootNode, TypeCopyMode::ReferenceType);
  RaverieClonableNode(IfRootNode);
...
{
public:
  RaverieDeclareType(SendsEventNode, TypeCopyMode::ReferenceType);
  RaverieClonableNode(SendsEventNode);
...
{
public:
  RaverieDeclareType(BreakNode, TypeCopyMode::ReferenceType);
  RaverieClonableNode(BreakNode);
...
{
public:
  RaverieDeclareType(DebugBreakNode, TypeCopyMode::ReferenceType);
  RaverieClonableNode(DebugBreakNode);
};
...
{
public:
  RaverieDeclareType(ContinueNode, TypeCopyMode::ReferenceType);
  RaverieClonableNode(ContinueNode);
...
{
public:
  RaverieDeclareType(ThrowNode, TypeCopyMode::ReferenceType);
  RaverieClonableNode(ThrowNode);
...
{
public:
  RaverieDeclareType(LoopScopeNode, TypeCopyMode::ReferenceType);
...
{
public:
  RaverieDeclareType(ConditionalLoopNode, TypeCopyMode::ReferenceType);
...
{
public:
  RaverieDeclareType(WhileNode, TypeCopyMode::ReferenceType);
  RaverieClonableNode(WhileNode);
};
...
{
public:
  RaverieDeclareType(DoWhileNode, TypeCopyMode::ReferenceType);
  RaverieClonableNode(DoWhileNode);
};
...
{
public:
  RaverieDeclareType(ForNode, TypeCopyMode::ReferenceType);
  RaverieClonableNode(ForNode);
...
{
public:
  RaverieDeclareType(ForEachNode, TypeCopyMode::ReferenceType);
  RaverieClonableNode(ForEachNode);
...
{
public:
  RaverieDeclareType(LoopNode, TypeCopyMode::ReferenceType);
  RaverieClonableNode(LoopNode);
};
...
{
public:
  RaverieDeclareType(GenericFunctionNode, TypeCopyMode::ReferenceType);
...
{
public:
  RaverieDeclareType(FunctionNode, TypeCopyMode::ReferenceType);
  RaverieClonableNode(FunctionNode);
...
{
public:
  RaverieDeclareType(InitializerNode, TypeCopyMode::ReferenceType);
  RaverieClonableNode(InitializerNode);
...
{
public:
  RaverieDeclareType(ConstructorNode, TypeCopyMode::ReferenceType);
  RaverieClonableNode(ConstructorNode);
...
{
public:
  RaverieDeclareType(DestructorNode, TypeCopyMode::ReferenceType);
  RaverieClonableNode(DestructorNode);
};
...
{
public:
  RaverieDeclareType(ClassNode, TypeCopyMode::ReferenceType);
  RaverieClonableNode(ClassNode);
...
{
public:
  RaverieDeclareType(EnumValueNode, TypeCopyMode::ReferenceType);
  RaverieClonableNode(EnumValueNode);
...
{
public:
  RaverieDeclareType(EnumNode, TypeCopyMode::ReferenceType);
  RaverieClonableNode(EnumNode);
...
{
public:
  RaverieDeclareType(TypeDefineNode, TypeCopyMode::ReferenceType);
  RaverieClonableNode(TypeDefineNode);
...
{
public:
  RaverieDeclareType(LocalVariableReferenceNode, TypeCopyMode::ReferenceType);
  RaverieClonableNode(LocalVariableReferenceNode);
