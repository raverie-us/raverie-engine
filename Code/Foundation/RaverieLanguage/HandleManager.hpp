...
private:
  ...
  // We consider this locked once we create RaverieSetup
  bool Locked;
};
...
enum Enum
{
  // Raverie will invoke the destructors and call delete on the object
  DeleteObject,
...
public:
  ...
  // be deleted by Raverie This function may destroy the object, but should NOT do
  // so via Raverie calls such as Delete on the Handle
...
// the memory and continue. However, often times Raverie objects inherit from C++
