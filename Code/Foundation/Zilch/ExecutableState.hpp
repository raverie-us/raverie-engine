...
template <>
ZilchCallHelperSpecialization(Any, const Any&);
template <>
ZilchCallHelperSpecialization(Any&, Any&);
template <>
ZilchCallHelperSpecialization(const Any*, const Any* const&);
template <>
ZilchCallHelperSpecialization(const Any&, const Any&);

template <>
ZilchCallHelperSpecialization(Handle*, Handle* const&);
template <>
ZilchCallHelperSpecialization(Handle, const Handle&);
template <>
ZilchCallHelperSpecialization(Handle&, Handle&);
template <>
ZilchCallHelperSpecialization(const Handle*, const Handle* const&);
template <>
ZilchCallHelperSpecialization(const Handle&, const Handle&);

template <>
ZilchCallHelperSpecialization(Delegate*, Delegate* const&);
template <>
ZilchCallHelperSpecialization(Delegate, const Delegate&);
template <>
ZilchCallHelperSpecialization(Delegate&, Delegate&);
template <>
ZilchCallHelperSpecialization(const Delegate*, const Delegate* const&);
template <>
ZilchCallHelperSpecialization(const Delegate&, const Delegate&);

template <typename T>
ZilchCallHelperTemplateSpecialization(HandleOf<T>*, HandleOf<T>* const&);
template <typename T>
ZilchCallHelperTemplateSpecialization(HandleOf<T>, const HandleOf<T>&);
template <typename T>
