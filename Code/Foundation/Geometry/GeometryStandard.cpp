...
RaverieDefineExternalBaseType(Ray, TypeCopyMode::ValueType, builder, type)
{
  ...
  RaverieFullBindMethod(builder, type, &Ray::GetPoint, RaverieNoOverload, "GetPoint", "tValue")->Description =
      RaverieDocumentString("Returns the point at the given t-value.");
  RaverieFullBindMethod(builder, type, &Ray::GetTValue, RaverieNoOverload, "GetTValue", "point")->Description =
      RaverieDocumentString("Returns the t-value that would result in the given "
...
RaverieDefineExternalBaseType(Segment, TypeCopyMode::ValueType, builder, type)
{
  ...
  RaverieFullBindMethod(builder, type, &Segment::GetPoint, RaverieNoOverload, "GetPoint", "tValue")->Description =
      RaverieDocumentString("Returns the point at the given t-value.");
  RaverieFullBindMethod(builder, type, &Segment::GetTValue, RaverieNoOverload, "GetTValue", "point")->Description =
      RaverieDocumentString("Returns the t-value that would result in the given "
...
RaverieDefineExternalBaseType(Aabb, TypeCopyMode::ValueType, builder, type)
{
  ...
  RaverieBindOverloadedMethodAs(Expand, RaverieStaticOverload(Aabb, const Aabb&, Vec3Param), "Expand")->Description =
      RaverieDocumentString("Creates an aabb that contains the given aabb and point.");
  RaverieBindOverloadedMethodAs(Combine, RaverieStaticOverload(Aabb, const Aabb&, const Aabb&), "Expand")->Description =
      RaverieDocumentString("Creates an aabb that contains the two given aabbs.");
  RaverieBindOverloadedMethodAs(Expand, RaverieInstanceOverload(void, Vec3Param), "Expand")->Description =
      RaverieDocumentString("Expand this aabb to contain the given point.");
  RaverieBindOverloadedMethodAs(Combine, RaverieInstanceOverload(void, const Aabb&), "Expand")->Description =
      RaverieDocumentString("Expand this aabb to contain the given aabb.");
  RaverieBindMethod(ContainsPoint)->Description = RaverieDocumentString("Does this aabb contain the given point?");
  RaverieBindMethodAs(Overlap, "Overlaps")->Description =
      RaverieDocumentString("Does this aabb overlap/intersect the given aabb?");
...
RaverieDefineExternalBaseType(Sphere, TypeCopyMode::ValueType, builder, type)
{
  ...
  RaverieBindOverloadedMethodAs(Expand, RaverieInstanceOverload(void, Vec3Param), "Expand")->Description =
      RaverieDocumentString("Expand this sphere to contain the given point.");
  RaverieBindMethodAs(Overlap, "Overlaps")->Description =
      RaverieDocumentString("Does this sphere overlap/intersect the given sphere?");
  RaverieBindGetter(Volume);
  RaverieBindGetter(SurfaceArea);
...
RaverieDefineExternalBaseType(Plane, TypeCopyMode::ValueType, builder, type)
{
  ...
  RaverieFullBindMethod(
      builder, type, &RaverieSelf::Set, RaverieInstanceOverload(void, Vec3Param, Vec3Param), "Set", "normal point");
