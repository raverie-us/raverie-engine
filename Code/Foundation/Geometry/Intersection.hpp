...
Type RayMeshBuffer(Vec3Param rayStart,
                   ...
                   bool anyIntersection = true,
                   uint* hitTriIndex = nullptr,
...
/// doesn't do anything.
Type TriangleTriangle(Vec3Param triangleOnePointA,
                      Vec3Param triangleOnePointB,
                      Vec3Param triangleOnePointC,
                      Vec3Param triangleTwoPointA,
                      Vec3Param triangleTwoPointB,
                      Vec3Param triangleTwoPointC,
