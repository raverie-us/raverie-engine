...
Manifold::Manifold(uint pointCount) : PointCount(pointCount)
{
  if (PointCount == 0)
  {
    PointCount = 1;
...
{
  ErrorIf(center == nullptr,
          "Physics::Mpr - Null pointer passed, this function "
...
{
  ErrorIf(translation == nullptr,
          "Physics::Mpr - Null pointer passed, this "
