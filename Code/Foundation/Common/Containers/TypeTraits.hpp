...
template <typename T>
struct remove_const_and_volatile
{
...
template <>
struct make_signed<ulonglong>
{
  typedef slonglong type;
};
template <>
...
template <>
struct make_signed<ushort>
{
  typedef sshort type;
};
template <>
struct make_signed<uchar>
{
  typedef schar type;
};
template <>
struct make_signed<slonglong>
{
  typedef slonglong type;
};
template <>
struct make_signed<slong>
{
  typedef slong type;
};
template <>
struct make_signed<sint>
{
  typedef sint type;
};
template <>
struct make_signed<sshort>
{
  typedef sshort type;
};
template <>
struct make_signed<schar>
{
  typedef schar type;
};
template <>
...
template <>
struct make_unsigned<slonglong>
{
  typedef ulonglong type;
};
template <>
struct make_unsigned<slong>
{
  typedef ulong type;
};
template <>
struct make_unsigned<sint>
{
  typedef uint type;
};
template <>
struct make_unsigned<sshort>
{
  typedef ushort type;
};
template <>
struct make_unsigned<schar>
{
  typedef uchar type;
};
template <>
struct make_unsigned<ulonglong>
{
  typedef ulonglong type;
};
template <>
...
struct MoveReference
{
  ...
  /// Constructors
  explicit MoveReference(T& reference) : mReference(reference)
  {
  }
  MoveReference(const MoveReference& rhs) : mReference(rhs.mReference)
  {
  }
...
#endif
template <typename T>
struct remove_reference<MoveReference<T>>
{
  typedef T type;
};
template <typename T>
