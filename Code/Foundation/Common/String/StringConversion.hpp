...
void ToValue(StringRangeParam range, ulong& value, int base = 0);
...
uint ToBuffer(char* buffer, uint bufferSize, ulong value, bool shortFormat = false);
...
template <typename T>
struct has_global_to_value_helper
{
...
template <typename T>
struct has_global_to_value : public integral_constant<bool, has_global_to_value_helper<T>::value>
{
};
...
template <typename T>
struct has_global_to_buffer_helper
{
...
/// else defined as false
template <typename T>
struct has_global_to_buffer : public integral_constant<bool, has_global_to_buffer_helper<T>::value>
{
};
