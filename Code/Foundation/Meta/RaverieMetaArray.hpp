...
class RaverieMetaArray : public MetaArray
{
public:
  ...
  RaverieDeclareType(RaverieMetaArray, TypeCopyMode::ReferenceType);

  typedef typename ArrayType::value_type ContainedType;

  RaverieMetaArray() : MetaArray(RaverieTypeId(ContainedType))
  {
  }
