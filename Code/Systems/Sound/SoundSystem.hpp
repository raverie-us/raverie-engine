...
{
public:
  RaverieDeclareType(SoundEvent, TypeCopyMode::ReferenceType);
...
{
public:
  RaverieDeclareType(MidiEvent, TypeCopyMode::ReferenceType);
...
{
public:
  RaverieDeclareType(AudioFloatDataEvent, TypeCopyMode::ReferenceType);
...
{
public:
  RaverieDeclareType(AudioByteDataEvent, TypeCopyMode::ReferenceType);
...
{
public:
  RaverieDeclareType(SoundSystem, TypeCopyMode::ReferenceType);
  ...
  /// The volume modifier applied to all audio generated by Raverie.
...
{
public:
  RaverieDeclareType(AudioSettings, TypeCopyMode::ReferenceType);
  ...
  /// An overall volume modifier that is applied to all audio produced by Raverie.
  float GetSystemVolume();
  void SetSystemVolume(float volume);
  /// When true, audio will be processed normally but will be silent.
  bool GetMuteAllAudio();
