...
private:
  int mBlockSize;
  int mSegmentCount;
  Raverie::Array<float> mStoredInputBuffer;
  int mBufferPosition;
  int mCurrentSegment;
  typedef Raverie::Array<ComplexNumber> ComplexListType;
  Raverie::Array<ComplexListType> mSegments;
  Raverie::Array<ComplexListType> mSegmentsIR;
