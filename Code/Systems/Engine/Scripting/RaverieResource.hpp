...
class RaverieLibraryResource : public Resource
{
public:
  RaverieDeclareType(RaverieLibraryResource, TypeCopyMode::ReferenceType);
...
// Raverie Document
class RaverieDocumentResource : public DocumentResource, public ICodeInspector
{
public:
  RaverieDeclareType(RaverieDocumentResource, TypeCopyMode::ReferenceType);

  RaverieDocumentResource();
  ...
  bool SupportsRaverieConnect() override;
