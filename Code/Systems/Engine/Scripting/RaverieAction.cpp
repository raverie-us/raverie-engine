...
struct EaseTypeFunc
{
  ...
  static void AddParam(LibraryBuilder& library, ParameterArray& params)
  {
    ...
    p4.ParameterType = RaverieTypeId(EaseType::Enum);
    p4.Name = "ease";
  }
...
struct EaseTypeSampleCurve
{
  ...
  {
    DelegateParameter& p4 = params.PushBack();
    p4.ParameterType = RaverieTypeId(SampleCurve);
    p4.Name = "ease";
  }
...
// Action that animates a raverie property
template <typename PropertyType, typename EaserType>
class RaveriePropertyAction : public Action
{
public:
  EaserType mEaser;
  float mDuration;
...
// Create the Raverie property action.
template <typename PropertyType, typename EaserType>
void CreateRaveriePropertyAction(Call& call, ExceptionReport& report)
{
  ...
  RaveriePropertyAction<PropertyType, EaserType>* action = new RaveriePropertyAction<PropertyType, EaserType>();
...
template <typename PropertyType, typename EaserType>
void AddRaverieActionProperty(LibraryBuilder& library)
{
  Array<Constant> typeParameters;
  typeParameters.PushBack(Constant(RaverieTypeId(PropertyType)));
  ...
  p2.ParameterType = RaverieTypeId(PropertyType);
  p2.Name = "endValue";
  DelegateParameter& p3 = params.PushBack();
  p3.ParameterType = RaverieTypeId(float);
  p3.Name = "duration";
...
void CreateCallAction(Call& call, ExceptionReport& report)
{
  ...
  RaverieCallAction* callAction = new RaverieCallAction();
...
void AddEvent(LibraryBuilder& library)
{
  ...
  p0.ParameterType = RaverieTypeId(ActionSet);
  DelegateParameter& p1 = params.PushBack();
  p1.ParameterType = RaverieTypeId(Object);
  DelegateParameter& p2 = params.PushBack();
...
{
  AddRaverieActionProperty<float, EaseTypeFunc>(library);
  AddRaverieActionProperty<Vec2, EaseTypeFunc>(library);
  AddRaverieActionProperty<Vec3, EaseTypeFunc>(library);
  AddRaverieActionProperty<Vec4, EaseTypeFunc>(library);
  AddRaverieActionProperty<Quat, EaseTypeFunc>(library);
  AddRaverieActionProperty<int, EaseTypeFunc>(library);
  AddRaverieActionProperty<bool, EaseTypeFunc>(library);
  AddRaverieActionProperty<String, EaseTypeFunc>(library);

  AddRaverieActionProperty<float, EaseTypeSampleCurve>(library);
  AddRaverieActionProperty<Vec2, EaseTypeSampleCurve>(library);
  AddRaverieActionProperty<Vec3, EaseTypeSampleCurve>(library);
  AddRaverieActionProperty<Vec4, EaseTypeSampleCurve>(library);
  AddRaverieActionProperty<Quat, EaseTypeSampleCurve>(library);
  AddRaverieActionProperty<int, EaseTypeSampleCurve>(library);
  AddRaverieActionProperty<bool, EaseTypeSampleCurve>(library);
  AddRaverieActionProperty<String, EaseTypeSampleCurve>(library);
