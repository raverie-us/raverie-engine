...
// Resource
/// Raverie script file Resource.
class RaverieScript : public RaverieDocumentResource
{
public:
  RaverieDeclareType(RaverieScript, TypeCopyMode::ReferenceType);
...
// RaverieScriptLoader
class RaverieScriptLoader : public ResourceLoader
{
public:
...
// Manager
// Resource manager for RaverieScript
class RaverieScriptManager : public ResourceManager
{
public:
  DeclareResourceManager(RaverieScriptManager, RaverieScript);

  RaverieScriptManager(BoundType* resourceType);
