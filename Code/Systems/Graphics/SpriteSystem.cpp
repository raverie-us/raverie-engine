...
u32 GetParticleSortValue(SpriteParticleSortMode::Enum sortMode, Vec3 pos, Vec3 camPos, Vec3 camDir)
{
  ...
  switch (sortMode)
  {
  case SpriteParticleSortMode::BackToFrontView:
    *floatValue = -Math::Dot(pos - camPos, camDir);
    break;
  case SpriteParticleSortMode::FrontToBackView:
    *floatValue = Math::Dot(pos - camPos, camDir);
    break;
  case SpriteParticleSortMode::NegativeToPositiveX:
    *floatValue = pos.x;
    break;
  case SpriteParticleSortMode::PositiveToNegativeX:
    *floatValue = -pos.x;
    break;
  case SpriteParticleSortMode::NegativeToPositiveY:
    *floatValue = pos.y;
    break;
  case SpriteParticleSortMode::PositiveToNegativeY:
    *floatValue = -pos.y;
    break;
  case SpriteParticleSortMode::NegativeToPositiveZ:
    *floatValue = pos.z;
    break;
  case SpriteParticleSortMode::PositiveToNegativeZ:
    *floatValue = -pos.z;
    break;
  default:
    break;
