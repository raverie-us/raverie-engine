...
RaverieEngineShaderGlslBackend::RaverieEngineShaderGlslBackend()
{
  mTargetVersion = 150;
  mTargetGlslEs = false;
}

String RaverieEngineShaderGlslBackend::GetExtension()
{
  return "glsl";
}
...
String RaverieEngineShaderGlslBackend::GetErrorLog()
{
  return mErrorLog;
}
