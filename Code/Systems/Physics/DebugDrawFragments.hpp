...
void DrawArc(
    Vec3Param center, Vec3Param normal, Vec3Param axis, real radiusA, real radiusB, real minAngle, real maxAngle, bool drawBoundaries, ByteColor color, real radianStepSize, bool leftHanded = false);
