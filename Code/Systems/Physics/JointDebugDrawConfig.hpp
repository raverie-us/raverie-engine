...
struct JointDebugDrawConfig : public Component
{
  ...
  /// Typically used when ObjectA is marked as a static object and ObjectB has
  /// free movement.
  ...
  /// Typically used when ObjectB is marked as a static object and ObjectA has
  /// free movement.
  ...
  /// RevoluteJoint will increase the number of lines used to draw the arc of a
  /// circle.
  real mDetail;
