...
public:
  ...
  static void WriteFile(Status& status, StringParam outputFileName, AudioFileData& fileData, bool normalize, float maxVolume);
...
private:
  ...
  static bool PcmToFloat(byte* inputBuffer, float** samplesPerChannel, const unsigned totalSampleCount, const unsigned channelCount, const unsigned bytesPerSample);
  ...
  static unsigned Resample(unsigned fileSampleRate, unsigned channels, unsigned samplesPerChannel, float**& buffersPerChannel);
