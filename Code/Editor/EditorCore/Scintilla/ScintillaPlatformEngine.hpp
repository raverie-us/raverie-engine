...
{
public:
  SurfaceImpl(Raverie::Widget* widget);
  ...
  void MakeViewNode(Raverie::PrimitiveType::Enum primitive, StringParam textureName);
  void MakeViewNode(Raverie::PrimitiveType::Enum primitive, Raverie::Texture* texture);

  Raverie::Widget* mWidget;

  Raverie::ViewBlock* mViewBlock;
  Raverie::FrameBlock* mFrameBlock;
  Raverie::ViewNode* mViewNode;
  Raverie::Vec4 mColor;
  Raverie::WidgetRect mClipRect;
  Raverie::WidgetRect mBaseRect;
