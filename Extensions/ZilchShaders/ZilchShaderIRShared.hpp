...
public:
  ...
  // Arg0 is Return type, remaining args are the parameters
...
public:
  ...
  // does the same thing as zilch's default constructor (i.e. invoke the pre-constructor)
