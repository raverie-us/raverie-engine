...
void WriteImageArguments(ZilchSpirVFrontEnd* translator, Zilch::FunctionCallNode* functionCallNode, ZilchShaderIROp* result, int index, ImageUserData& imageData, ZilchSpirVFrontEndContext* context)
{
...
inline void ResolveCombinedSamplerFunction(ZilchSpirVFrontEnd* translator, Zilch::FunctionCallNode* functionCallNode, Zilch::MemberAccessNode* memberAccessNode, ZilchSpirVFrontEndContext* context)
{
...
// Resolves a function that operates on a SampledImage but is given a Sampler and an Image and must combine them into a temporary.
template <OpType opType>
inline void ResolveSplitImageSamplerFunction(ZilchSpirVFrontEnd* translator, Zilch::FunctionCallNode* functionCallNode, Zilch::MemberAccessNode* memberAccessNode, ZilchSpirVFrontEndContext* context)
{
  ImageUserData& imageData = memberAccessNode->AccessedFunction->ComplexUserData.ReadObject<ImageUserData>(0);
  ZilchShaderIRType* resultType = translator->FindType(functionCallNode->ResultType, functionCallNode);
  ...
  ZilchShaderIROp* sampledImageValue = translator->BuildCurrentBlockIROp(OpType::OpSampledImage, sampledImageType, imageValue, samplerValue, context);
...
// Resolves a function that operates on an Image. If the input is a SampledImage this will first grab the image from the sampler.
template <OpType opType>
inline void ResolveImageFunction(ZilchSpirVFrontEnd* translator, Zilch::FunctionCallNode* functionCallNode, Zilch::MemberAccessNode* memberAccessNode, ZilchSpirVFrontEndContext* context)
{
  ImageUserData& imageData = memberAccessNode->AccessedFunction->ComplexUserData.ReadObject<ImageUserData>(0);
  ZilchShaderIRType* resultType = translator->FindType(functionCallNode->ResultType, functionCallNode);
...
void AddImageFetch(Zilch::LibraryBuilder& builder, Zilch::BoundType* type, SampledImageSet& set,
  Zilch::BoundType* coordianteType, Zilch::BoundType* returnType)
{
  Zilch::Function* fn = nullptr;
  ParameterArray parameters;
...
void AddImageFetchLod(Zilch::LibraryBuilder& builder, Zilch::BoundType* type, SampledImageSet& set,
