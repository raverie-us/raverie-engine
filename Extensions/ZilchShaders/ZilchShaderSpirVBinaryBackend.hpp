...
private:
  ...
  void AddDecorationCapabilities(EntryPointInfo* entryPoint, TypeDependencyCollector& collector, ZilchShaderToSpirVContext* context);
  void AddDecorationCapabilities(ZilchShaderIROp* decorationOp, TypeDependencyCollector& collector, ZilchShaderToSpirVContext* context);
  void AddMemberDecorationCapabilities(ZilchShaderIROp* memberDecorationOp, TypeDependencyCollector& collector, ZilchShaderToSpirVContext* context);
  ...
  void WriteSpecializationConstantBindingDecorations(TypeDependencyCollector& typeCollector, ZilchShaderToSpirVContext* context);
  ...
  void WriteBlockInstructions(BasicBlock* block, Array<IZilchShaderIR*>& instructions, ZilchShaderToSpirVContext* context);
