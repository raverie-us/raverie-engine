...
class Selection {
	ScVector<SelectionRange> ranges;
	ScVector<SelectionRange> rangesSaved;
...
public:
	...
	ScVector<SelectionRange> RangesCopy() const {
		return ranges;
	}
  ScVector<SelectionRange>& GetRanges() { return ranges; } // ZERO ENGINE EDIT
};
