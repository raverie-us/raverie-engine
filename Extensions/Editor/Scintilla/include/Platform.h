...
//Zero is a custom platform since we do not use
//any OS features
#define PLAT_ZERO 1
...
public:
	...
	static void Assertion(const char *c, const char *file, int line);
...
#else
#ifdef SCI_NAMESPACE
#define PLATFORM_ASSERT(c) ((c) ? (void)(0) : Scintilla::Platform::Assertion(#c, __FILE__, __LINE__))
#else
#define PLATFORM_ASSERT(c) ((c) ? (void)(0) : Platform::Assertion(#c, __FILE__, __LINE__))
#endif
#endif
