...
FindTextDialog::FindTextDialog(Composite* parent) : Composite(parent)
{
  ...
  mSearchModeSource.SetEnum(SearchMode::EnumName, SearchMode::Names);
  ...
  mLookInSource.SetEnum(LookIn::EnumName, LookIn::Names);
  ...
  mDirectionSource.SetEnum(Direction::EnumName, Direction::Names);
  ...
  mRegexFlavorSource.SetEnum(RegexFlavor::EnumName, RegexFlavor::Names);
