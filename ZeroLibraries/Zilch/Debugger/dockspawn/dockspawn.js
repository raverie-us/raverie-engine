...
dockspawn.TabHandle = function(parent)
{
    ...
    this.elementCloseButton.innerHTML = 'x';
...
dockspawn.Dialog.prototype._initialize = function()
{
    ...
    this.panel.resize(this.panel.elementPanel.clientWidth, this.panel.elementPanel.clientHeight - this.panel.elementTitle.clientHeight);
};
...
dockspawn.PanelContainer.prototype._initialize = function()
{
    ...
    this.elementButtonClose.innerHTML = 'x';
...
dockspawn.PanelContainer.prototype._setPanelDimensions = function(width, height)
{
    ...
    var adjustForPadding = 0;
    if (titleBarHeight != 0)
    {
      // Hack, not sure how to grab the padding properly for the window (need top + bottom padding)
      adjustForPadding = 8;
    }
    
    var contentHeight = height - titleBarHeight;
    this.elementContentHost.style.height = contentHeight - 4 + "px";
    this.elementContent.style.height = contentHeight - adjustForPadding + "px";
