...
namespace Audio
{
  static float degreesToRadians = Math::cTwoPi / 360.0f;

  static float FrontSpeakerRadians = 90.0f * degreesToRadians;
  static float SideSpeakerRadians = 110.0f * degreesToRadians;
  static float BackSpeakerRadians = 145.0f * degreesToRadians;
