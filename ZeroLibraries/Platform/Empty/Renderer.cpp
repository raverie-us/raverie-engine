...
public:
  ...
  bool YInvertImageData(TextureType::Enum type) override { return false;  }

  MaterialRenderData* CreateMaterialRenderData() override { return nullptr; }
  MeshRenderData* CreateMeshRenderData() override { return nullptr; }
  TextureRenderData* CreateTextureRenderData() override { return nullptr; }
  ...
  bool GetLazyShaderCompilation() override { return false; }
