...
/// debug drawing to make it easier to debug an algorithm without having to early-out
/// or make it re-entrant. This does come at a severe memory overhead so some algorithms
/// can fail when large enough.
...
public:
  ...
  // Sometimes it can be difficult/annoying to store a bunch of information about how
  // a sub-portion of an algorithm should draw, such as the location of any debug text.
  // To work around this, base debug shapes are stored here that can be modified by the
